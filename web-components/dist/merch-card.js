var Kt=Object.defineProperty;var Qt=i=>{throw TypeError(i)};var xi=(i,t,e)=>t in i?Kt(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var vi=(i,t)=>()=>(i&&(t=i(i=0)),t);var bi=(i,t)=>{for(var e in t)Kt(i,e,{get:t[e],enumerable:!0})};var d=(i,t,e)=>xi(i,typeof t!="symbol"?t+"":t,e),wt=(i,t,e)=>t.has(i)||Qt("Cannot "+e);var c=(i,t,e)=>(wt(i,t,"read from private field"),e?e.call(i):t.get(i)),g=(i,t,e)=>t.has(i)?Qt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(i):t.set(i,e),m=(i,t,e,r)=>(wt(i,t,"write to private field"),r?r.call(i,e):t.set(i,e),e),S=(i,t,e)=>(wt(i,t,"access private method"),e);var Xt=(i,t,e,r)=>({set _(a){m(i,t,a,e)},get _(){return c(i,t,r)}});var Et={};bi(Et,{default:()=>Oe});import{LitElement as yi,html as Je,css as wi}from"./lit-all.min.js";function Ei(){return customElements.get("sp-tooltip")!==void 0&&customElements.get("overlay-trigger")!==void 0&&document.querySelector("sp-theme")!==null}var T,Oe,kt=vi(()=>{T=class T extends yi{constructor(){super(),this.content="",this.placement="top",this.variant="info",this.size="xs",this.tooltipVisible=!1,this.lastPointerType=null,this.handleClickOutside=this.handleClickOutside.bind(this)}connectedCallback(){super.connectedCallback(),window.addEventListener("mousedown",this.handleClickOutside)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mousedown",this.handleClickOutside)}handleClickOutside(t){let e=t.composedPath();T.activeTooltip===this&&!e.includes(this)&&this.hideTooltip()}showTooltip(){T.activeTooltip&&T.activeTooltip!==this&&(T.activeTooltip.closeOverlay(),T.activeTooltip.tooltipVisible=!1,T.activeTooltip.requestUpdate()),T.activeTooltip=this,this.tooltipVisible=!0}hideTooltip(){T.activeTooltip===this&&(T.activeTooltip=null),this.tooltipVisible=!1}handleTap(t){t.preventDefault(),this.tooltipVisible?this.hideTooltip():this.showTooltip()}closeOverlay(){let t=this.shadowRoot?.querySelector("overlay-trigger");t?.open!==void 0&&(t.open=!1)}get effectiveContent(){return this.tooltipText||this.mnemonicText||this.content||""}get effectivePlacement(){return this.tooltipPlacement||this.mnemonicPlacement||this.placement||"top"}renderIcon(){return this.src?Je`<merch-icon
            src="${this.src}"
            size="${this.size}"
        ></merch-icon>`:Je`<slot></slot>`}render(){let t=this.effectiveContent,e=this.effectivePlacement;return t?Ei()?Je`
                <overlay-trigger
                    placement="${e}"
            ...
            `:this.renderIcon()}};d(T,"activeTooltip",null),d(T,"properties",{content:{type:String},placement:{type:String},variant:{type:String},src:{type:String},size:{type:String},tooltipText:{type:String,attribute:"tooltip-text"},tooltipPlacement:{type:String,attribute:"tooltip-placement"},mnemonicText:{type:String,attribute:"mnemonic-text"},mnemonicPlacement:{type:String,attribute:"mnemonic-placement"},tooltipVisible:{type:Boolean,state:!0}}),d(T,"styles",wi`
        :host {
            display: contents;
            overflow: visible;
        }
    ...
    `);Oe=T;customElements.define("mas-mnemonic",Oe)});import{LitElement as Ka}from"./lit-all.min.js";import{css as er,unsafeCSS as Jt}from"./lit-all.min.js";var b="(max-width: 767px)",M="(max-width: 1199px)",y="(min-width: 768px)",u="(min-width: 1200px)",A="(min-width: 1600px)",Zt={matchMobile:window.matchMedia(b),matchDesktop:window.matchMedia(`${u} and (not ${A})`),matchDesktopOrUp:window.matchMedia(u),matchLargeDesktop:window.matchMedia(A),get isMobile(){return this.matchMobile.matches},get isDesktop(){return this.matchDesktop.matches},get isDesktopOrUp(){return this.matchDesktopOrUp.matches}},f=Zt;function Ze(){return Zt.isDesktop}var tr=er`
    :host {
...
`,rr=()=>[er`
        ...
        `];import{LitElement as ki,html as ir,css as Si}from"./lit-all.min.js";function Ci(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var de=class extends ki{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(Ci())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(e=>{let r="",a="top";if(e.tagName==="SP-TOOLTIP")r=e.textContent,a=e.getAttribute("placement")||"top";else if(e.tagName==="OVERLAY-TRIGGER"){let n=e.querySelector("sp-tooltip");n&&(r=n.textContent,a=n.getAttribute("placement")||e.getAttribute("placement")||"top")}if(r){let n=document.createElement("mas-mnemonic");n.setAttribute("content",r),n.setAttribute("placement",a);let o=this.querySelector("img"),s=this.querySelector("a");s&&s.contains(o)?n.appendChild(s):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>kt())}e.remove()})}render(){let{href:t}=this;return t?ir`<a href="${t}">
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};d(de,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),d(de,"styles",Si`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
    ...
    `);customElements.define("merch-icon",de);var dn=Object.freeze({MONTH:"MONTH",YEAR:"YEAR",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",PERPETUAL:"PERPETUAL",TERM_LICENSE:"TERM_LICENSE",ACCESS_PASS:"ACCESS_PASS",THREE_MONTHS:"THREE_MONTHS",SIX_MONTHS:"SIX_MONTHS"}),pn=Object.freeze({ANNUAL:"ANNUAL",MONTHLY:"MONTHLY",TWO_YEARS:"TWO_YEARS",THREE_YEARS:"THREE_YEARS",P1D:"P1D",P1Y:"P1Y",P3Y:"P3Y",P10Y:"P10Y",P15Y:"P15Y",P3D:"P3D",P7D:"P7D",P30D:"P30D",HALF_YEARLY:"HALF_YEARLY",QUARTERLY:"QUARTERLY"});var w='span[is="inline-price"][data-wcs-osi]',G='a[is="checkout-link"][data-wcs-osi],button[is="checkout-button"][data-wcs-osi]';var Ai='a[is="upt-link"]',ar=`${w},${G},${Ai}`;var nr="merch-offer-select:ready",or="merch-card:action-menu-toggle";var H="merch-quantity-selector:change",sr="merch-card-quantity:change",St="merch-modal:addon-and-quantity-update";var pe="merch-card-collection:literals-changed";var he="aem:load",me="aem:error",cr="mas:ready",lr="mas:error",dr="placeholder-failed",pr="placeholder-pending",hr="placeholder-resolved";var mr="mas:failed",De="mas:resolved",gr="mas/commerce";var V="failed",Z="pending",W="resolved";var et="X-Request-Id",hn=Object.freeze({SEGMENTATION:"segmentation",BUNDLE:"bundle",COMMITMENT:"commitment",RECOMMENDATION:"recommendation",EMAIL:"email",PAYMENT:"payment",CHANGE_PLAN_TEAM_PLANS:"change-plan/team-upgrade/plans",CHANGE_PLAN_TEAM_PAYMENT:"change-plan/team-upgrade/payment"});var mn=Object.freeze({STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"});var tt=":start",rt=":duration";var it="legal",ur="mas-ff-defaults";var Ti="mas-commerce-service";function fr(i,t){let e;return function(){let r=this,a=arguments;clearTimeout(e),e=setTimeout(()=>i.apply(r,a),t)}}function L(i,t={},e=null,r=null){let a=r?document.createElement(i,{is:r}):document.createElement(i);e instanceof HTMLElement?a.appendChild(e):a.innerHTML=e;for(let[n,o]of Object.entries(t))a.setAttribute(n,o);return a}function ge(i){return`startTime:${i.startTime.toFixed(2)}|duration:${i.duration.toFixed(2)}`}function Ct(){return window.matchMedia("(max-width: 1024px)").matches}function J(){return document.getElementsByTagName(Ti)?.[0]}function $e(i){let t=window.getComputedStyle(i);return i.offsetHeight+parseFloat(t.marginTop)+parseFloat(t.marginBottom)}var Ne,ee,Fe,Ie,ue,at=class extends HTMLElement{constructor(){super();g(this,Ne,"");g(this,ee);g(this,Fe,[]);g(this,Ie,[]);g(this,ue);m(this,ue,fr(()=>{this.isConnected&&(this.parentElement.style.background=this.value,c(this,ee)?this.parentElement.style.borderRadius=c(this,ee):c(this,ee)===""&&(this.parentElement.style.borderRadius=""))},1))}static get observedAttributes(){return["colors","positions","angle","border-radius"]}get value(){let e=c(this,Fe).map((r,a)=>{let n=c(this,Ie)[a]||"";return`${r} ${n}`}).join(", ");return`linear-gradient(${c(this,Ne)}, ${e})`}connectedCallback(){c(this,ue).call(this)}attributeChangedCallback(e,r,a){e==="border-radius"&&m(this,ee,a?.trim()),e==="colors"&&a?m(this,Fe,a?.split(",").map(n=>n.trim())??[]):e==="positions"&&a?m(this,Ie,a?.split(",").map(n=>n.trim())??[]):e==="angle"&&m(this,Ne,a?.trim()??""),c(this,ue).call(this)}};Ne=new WeakMap,ee=new WeakMap,Fe=new WeakMap,Ie=new WeakMap,ue=new WeakMap;customElements.define("merch-gradient",at);import{LitElement as Li,html as zi,css as _i}from"./lit-all.min.js";var fe=class extends Li{constructor(){super(),this.planType=void 0,this.checked=!1,this.updatePlanType=this.updatePlanType.bind(this),this.handleChange=this.handleChange.bind(this),this.handleCustomClick=this.handleCustomClick.bind(this)}getOsi(t,e){let n=({TRIAL:["TRIAL"],BASE:["BASE","PROMOTION","TRIAL"],PROMOTION:["PROMOTION","BASE","TRIAL"]}[e]||[e]).map(s=>`p[data-plan-type="${t}"] ${w}[data-offer-type="${s}"]`).join(", ");return this.querySelector(n)?.dataset?.wcsOsi}connectedCallback(){super.connectedCallback(),this.addEventListener(De,this.updatePlanType)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(De,this.updatePlanType)}updatePlanType(t){if(t.target.tagName!=="SPAN")return;let e=t.target,r=e?.value?.[0];r&&(e.setAttribute("data-offer-type",r.offerType),e.closest("p").setAttribute("data-plan-type",r.planType))}handleChange(t){this.checked=t.target.checked,this.dispatchEvent(new CustomEvent("change",{detail:{checked:this.checked},bubbles:!0,composed:!0}))}handleCustomClick(){this.shadowRoot.querySelector("input").click()}handleKeyDown(t){t.key===" "&&(t.preventDefault(),this.handleCustomClick())}render(){return zi` <input
                type="checkbox"
                id="addon-checkbox"
            ...
            <label id="custom-checkbox-label" for="addon-checkbox">
                <slot></slot>
            </label>`}};d(fe,"properties",{planType:{type:String,attribute:"plan-type",reflect:!0},checked:{type:Boolean,reflect:!0},customCheckbox:{type:Boolean,attribute:"custom-checkbox",reflect:!0}}),d(fe,"styles",_i`
        :host {
            --merch-addon-gap: 9px;
    ...
    `);customElements.define("merch-addon",fe);import{html as nt,nothing as Pi}from"./lit-all.min.js";var xe,Be=class Be{constructor(t){d(this,"card");g(this,xe);this.card=t,this.insertVariantStyle()}getContainer(){return m(this,xe,c(this,xe)??this.card.closest('merch-card-collection, [class*="-merch-cards"]')??this.card.parentElement),c(this,xe)}insertVariantStyle(){let t=this.constructor.name;if(!Be.styleMap[t]){Be.styleMap[t]=!0;let e=document.createElement("style");e.innerHTML=this.getGlobalCSS(),document.head.appendChild(e)}}updateCardElementMinHeight(t,e){if(!t)return;let r=`--consonant-merch-card-${this.card.variant}-${e}-height`,a=Math.max(0,parseInt(window.getComputedStyle(t).height)||0),n=parseInt(this.getContainer().style.getPropertyValue(r))||0;a>n&&this.getContainer().style.setProperty(r,`${a}px`)}get badge(){let t;if(!(!this.card.badgeBackgroundColor||!this.card.badgeColor||!this.card.badgeText))return this.evergreen&&(t=`border: 1px solid ${this.card.badgeBackgroundColor}; border-right: none;`),nt`
            <div
                id="badge"
        ...
        `}get cardImage(){return nt` <div class="image">
            ...
            ${this.badge}
        </div>`}getGlobalCSS(){return""}get theme(){return document.querySelector("sp-theme")}get evergreen(){return this.card.classList.contains("intro-pricing")}get promoBottom(){return this.card.classList.contains("promo-bottom")}get headingSelector(){return'[slot="heading-xs"]'}get secureLabel(){return this.card.secureLabel?nt`<span class="secure-transaction-label"
                  >${this.card.secureLabel}</span
              >`:Pi}get secureLabelFooter(){return nt`<footer>
            ${this.secureLabel}<slot name="footer"></slot>
        </footer>`}async adjustTitleWidth(){let t=this.card.getBoundingClientRect().width,e=this.card.badgeElement?.getBoundingClientRect().width||0;t===0||e===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-e-16)}px`)}async postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}syncHeights(){}renderLayout(){}get aemFragmentMapping(){return ot(this.card.variant)}};xe=new WeakMap,d(Be,"styleMap",{});var x=Be;import{html as At,css as Mi}from"./lit-all.min.js";var xr=`
:root {
...
merch-card[variant="catalog"] [slot="footer"] .spectrum-Link--primary {
  ...
  font-weight: 700;
    ...
    `);import{html as He}from"./lit-all.min.js";var br=`
:root {
...
`;var st=class extends x{constructor(t){super(t)}getGlobalCSS(){return br}renderLayout(){return He`${this.cardImage}
            <div class="body">
                <slot name="icons"></slot>
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
                ${this.promoBottom?He`<slot name="body-xs"></slot
                          ><slot name="promo-text"></slot>`:He`<slot name="promo-text"></slot
                          ><slot name="body-xs"></slot>`}
            </div>
            ${this.evergreen?He`
                      <div
                  ...
                  `:He`
                      <hr />
                      ${this.secureLabelFooter}
                  `}`}};import{html as wr}from"./lit-all.min.js";var yr=`
:root {
...
`;var ct=class extends x{constructor(t){super(t)}getGlobalCSS(){return yr}renderLayout(){return wr` ${this.badge}
            <div class="body">
                <div class="top-section">
                    <slot name="icons"></slot>
                    <slot name="heading-xs"></slot>
            ...
            ${this.card.customHr?"":wr`<hr />`} ${this.secureLabelFooter}`}};import{html as be,css as Ri,unsafeCSS as kr}from"./lit-all.min.js";var Er=`
  :root {
...
`;var Oi=32,ye=class extends x{constructor(e){super(e);d(this,"getRowMinHeightPropertyName",e=>`--consonant-merch-card-footer-row-${e}-min-height`);d(this,"getMiniCompareFooter",()=>{let e=this.card.secureLabel?be`<slot name="secure-transaction-label">
                  <span class="secure-transaction-label"
                      >${this.card.secureLabel}</span
                  ></slot
              >`:be`<slot name="secure-transaction-label"></slot>`;return be`<footer>${e}<slot name="footer"></slot></footer>`});this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}connectedCallbackHook(){this.card.addEventListener(H,this.updatePriceQuantity)}disconnectedCallbackHook(){this.card.removeEventListener(H,this.updatePriceQuantity)}updatePriceQuantity({detail:e}){!this.mainPrice||!e?.option||(this.mainPrice.dataset.quantity=e.option)}getGlobalCSS(){return Er}adjustMiniCompareBodySlots(){if(this.card.getBoundingClientRect().width<=2)return;this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(".top-section"),"top-section");let e=["heading-m","body-m","heading-m-price","body-xxs","price-commitment","offers","promo-text","callout-content"];this.card.classList.contains("bullet-list")&&e.push("footer-rows"),e.forEach(a=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${a}"]`),a)),this.updateCardElementMinHeight(this.card.shadowRoot.querySelector("footer"),"footer"),this.card.shadowRoot.querySelector(".mini-compare-chart-badge")?.textContent!==""&&this.getContainer().style.setProperty("--consonant-merch-card-mini-compare-chart-top-section-mobile-height","32px")}adjustMiniCompareFooterRows(){if(this.card.getBoundingClientRect().width===0)return;let e=this.card.querySelector('[slot="footer-rows"] ul');!e||!e.children||[...e.children].forEach((r,a)=>{let n=Math.max(Oi,parseFloat(window.getComputedStyle(r).height)||0),o=parseFloat(this.getContainer().style.getPropertyValue(this.getRowMinHeightPropertyName(a+1)))||0;n>o&&this.getContainer().style.setProperty(this.getRowMinHeightPropertyName(a+1),`${n}px`)})}removeEmptyRows(){this.card.querySelectorAll(".footer-row-cell").forEach(r=>{let a=r.querySelector(".footer-row-cell-description");a&&!a.textContent.trim()&&r.remove()})}get mainPrice(){return this.card.querySelector(`[slot="heading-m-price"] ${w}[data-template="price"]`)}get headingMPriceSlot(){return this.card.shadowRoot.querySelector('slot[name="heading-m-price"]')?.assignedElements()[0]}toggleAddon(e){let r=this.mainPrice,a=this.headingMPriceSlot;if(!r&&a){let n=e?.getAttribute("plan-type"),o=null;if(e&&n&&(o=e.querySelector(`p[data-plan-type="${n}"]`)?.querySelector('span[is="inline-price"]')),this.card.querySelectorAll('p[slot="heading-m-price"]').forEach(s=>s.remove()),e.checked){if(o){let s=L("p",{class:"addon-heading-m-price-addon",slot:"heading-m-price"},o.innerHTML);this.card.appendChild(s)}}else{let s=L("p",{class:"card-heading",id:"free",slot:"heading-m-price"},"Free");this.card.appendChild(s)}}}async adjustAddon(){await this.card.updateComplete;let e=this.card.addon;if(!e)return;let r=this.mainPrice,a=this.card.planType;if(r&&(await r.onceSettled(),a=r.value?.[0]?.planType),!a)return;e.planType=a,this.card.querySelector("merch-addon[plan-type]")?.updateComplete.then(()=>{this.updateCardElementMinHeight(this.card.shadowRoot.querySelector('slot[name="addon"]'),"addon")})}renderLayout(){return be` <div class="top-section${this.badge?" badge":""}">
                <slot name="icons"></slot> ${this.badge}
            </div>
            <slot name="heading-m"></slot>
            ${this.card.classList.contains("bullet-list")?be`<slot name="heading-m-price"></slot>
                      ...
                      <slot name="offers"></slot>`:be`<slot name="body-m"></slot>
            ...
            <slot name="footer-rows"><slot name="body-s"></slot></slot>`}async postCardUpdateHook(){await Promise.all(this.card.prices.map(e=>e.onceSettled())),await this.adjustAddon(),f.isMobile?this.removeEmptyRows():(this.adjustMiniCompareBodySlots(),this.adjustMiniCompareFooterRows())}};d(ye,"variantStyle",Ri`
    ...
    `);import{html as qe,css as Di,nothing as lt}from"./lit-all.min.js";var Sr=`
:root {
...
`;var we=class extends x{constructor(t){super(t),this.postCardUpdateHook=this.postCardUpdateHook.bind(this),this.updatePriceQuantity=this.updatePriceQuantity.bind(this)}getGlobalCSS(){return _r}adjustProductBodySlots(){if(this.card.getBoundingClientRect().width===0)return;["heading-xs","body-xxs","body-xs","promo-text","callout-content","addon","body-lower"].forEach(e=>this.updateCardElementMinHeight(this.card.shadowRoot.querySelector(`slot[name="${e}"]`),e))}renderLayout(){return Tt` ${this.badge}
    ...
    `);import{html as Lt,css as Fi}from"./lit-all.min.js";var Pr=`
:root {
...
`;var Ee=class extends x{constructor(t){super(t)}getGlobalCSS(){return Pr}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return Lt` ${this.badge}
            <div class="body">
                <slot name="heading-xs"></slot>
                <slot name="body-xxs"></slot>
            ...
            <hr />
            ${this.secureLabelFooter}`}};d(Ee,"variantStyle",Fi`
    ...
    `);import{html as zt,css as Ii}from"./lit-all.min.js";var Mr=`
:root {
...
`;var Rr={cardName:{attribute:"name"},backgroundImage:{tag:"div",slot:"bg-image"},subtitle:{tag:"p",slot:"detail-m"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"heading-xs-price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"},badgeIcon:!0,badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300-special-offers"},allowedBadgeColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],allowedBorderColors:["spectrum-yellow-300-special-offers","spectrum-gray-300-special-offers","spectrum-green-900-special-offers"],borderColor:{attribute:"border-color"}},ke=class extends x{constructor(t){super(t)}get headingSelector(){return'[slot="detail-m"]'}getGlobalCSS(){return Mr}renderLayout(){return zt`${this.cardImage}
            ...
            ${this.evergreen?zt`
                  ...
                  `:zt`
                      ...
                      ${this.secureLabelFooter}
                  `}
            <slot></slot>`}};d(ke,"variantStyle",Ii`
    ...
    `);import{html as Bi,css as Hi}from"./lit-all.min.js";var Or=`
:root {
...
`;var _t={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-xs",maxCount:2e3,withSuffix:!1},prices:{tag:"div",slot:"price"},ctas:{slot:"cta",size:"XL"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},disabledAttributes:["badgeColor","badgeBorderColor","trialBadgeColor","trialBadgeBorderColor"],supportsDefaultChild:!0},Se=class extends x{getGlobalCSS(){return Or}get aemFragmentMapping(){return _t}get headingSelector(){return'[slot="heading-xs"]'}get badge(){return this.card.querySelector('[slot="badge"]')}syncHeights(){if(this.card.getBoundingClientRect().width===0)return;let t=this.card.querySelector('[slot="body-xs"]');t&&this.updateCardElementMinHeight(t,"description");let e=this.card.querySelector('[slot="price"]');e&&this.updateCardElementMinHeight(e,"price");let r=this.card.querySelector('[slot="body-xs"] p:has(mas-mnemonic)');r&&this.updateCardElementMinHeight(r,"icons")}async postCardUpdateHook(){if(this.card.isConnected&&(await this.card.updateComplete,this.card.prices?.length&&await Promise.all(this.card.prices.map(t=>t.onceSettled?.())),f.isDesktopOrUp)){let t=this.getContainer();if(!t)return;requestAnimationFrame(()=>{t.querySelectorAll(`merch-card[variant="${this.card.variant}"]`).forEach(r=>r.variantLayout?.syncHeights?.())})}}connectedCallbackHook(){!this.card||this.card.failed||(this.setupAccordion(),this.card?.hasAttribute("data-default-card")&&!Ze()&&this.card.setAttribute("data-expanded","true"))}setupAccordion(){let t=this.card;if(!t)return;let e=()=>{if(Ze())t.removeAttribute("data-expanded");else{let a=t.hasAttribute("data-default-card");t.setAttribute("data-expanded",a?"true":"false")}};e();let r=window.matchMedia(b);this.mediaQueryListener=()=>{e()},r.addEventListener("change",this.mediaQueryListener)}disconnectedCallbackHook(){this.mediaQueryListener&&window.matchMedia(b).removeEventListener("change",this.mediaQueryListener)}handleChevronClick(t){t.preventDefault(),t.stopPropagation(),this.toggleExpanded()}handleCardClick(t){t.target.closest('.chevron-button, mas-mnemonic, button, a, [role="button"]')||(t.preventDefault(),this.toggleExpanded())}toggleExpanded(){let t=this.card;if(!t||Ze())return;let a=t.getAttribute("data-expanded")==="true"?"false":"true";t.setAttribute("data-expanded",a)}renderLayout(){return Bi`
    ...
    `);import{html as $r,css as qi}from"./lit-all.min.js";var Dr=`
:root {
...
`;var Pt={title:{tag:"h3",slot:"heading-xs",maxCount:250,withSuffix:!0},badge:{tag:"div",slot:"badge",default:"spectrum-blue-400"},allowedBadgeColors:["spectrum-blue-400","spectrum-gray-300","spectrum-yellow-300","gradient-purple-blue","gradient-firefly-spectrum"],description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},shortDescription:{tag:"div",slot:"short-description",maxCount:3e3,withSuffix:!1},prices:{tag:"div",slot:"price"},trialBadge:{tag:"div",slot:"trial-badge"},ctas:{slot:"cta",size:"XL"},mnemonics:{size:"xs"},borderColor:{attribute:"border-color",specialValues:{gray:"var(--spectrum-gray-300)",blue:"var(--spectrum-blue-400)","gradient-purple-blue":"linear-gradient(96deg, #B539C8 0%, #7155FA 66%, #3B63FB 100%)","gradient-firefly-spectrum":"linear-gradient(96deg, #D73220 0%, #D92361 33%, #7155FA 100%)"}},multiWhatsIncluded:"true",disabledAttributes:[]},Ce=class extends x{getGlobalCSS(){return Dr}get aemFragmentMapping(){return Pt}get headingSelector(){return'[slot="heading-xs"]'}get badgeElement(){return this.card.querySelector('[slot="badge"]')}get badge(){return $r`
    ...
    `);import{css as Ui,html as ji}from"./lit-all.min.js";var Nr=`
...
`;var Fr={title:{tag:"p",slot:"title"},prices:{tag:"p",slot:"prices"},description:{tag:"p",slot:"description"},planType:!0,ctas:{slot:"ctas",size:"S"}},Ae=class extends x{constructor(){super(...arguments);d(this,"legal")}async postCardUpdateHook(){await this.card.updateComplete,this.adjustLegal()}getGlobalCSS(){return Nr}get headingSelector(){return'[slot="title"]'}priceOptionsProvider(e,r){r.literals={...r.literals,strikethroughAriaLabel:"",alternativePriceAriaLabel:""},r.space=!0,r.displayAnnual=this.card.settings?.displayAnnual??!1}adjustLegal(){if(this.legal!==void 0)return;let e=this.card.querySelector(`${w}[data-template="price"]`);if(!e)return;let r=e.cloneNode(!0);this.legal=r,e.dataset.displayTax="false",e.dataset.displayPerUnit="false",r.dataset.template="legal",r.dataset.displayPlanType=this.card?.settings?.displayPlanType??!0,r.setAttribute("slot","legal"),this.card.appendChild(r)}renderLayout(){return ji`
            ${this.badge}
            <div class="body">
    ...
    `);var ht=new Map,Ir=new WeakMap,Br=new Map,C=(i,t,e=null,r=null,a)=>{ht.set(i,{class:t,fragmentMapping:e,style:r,collectionOptions:a})};C("catalog",ve,vr,ve.variantStyle);C("image",st);C("inline-heading",ct);C("mini-compare-chart",ye,null,ye.variantStyle);C("plans",z,dt,z.variantStyle,z.collectionOptions);C("plans-students",z,Ar,z.variantStyle,z.collectionOptions);C("plans-education",z,Cr,z.variantStyle,z.collectionOptions);C("plans-v2",Y,zr,Y.variantStyle,Y.collectionOptions);C("product",we,null,we.variantStyle);C("segment",Ee,null,Ee.variantStyle);C("special-offers",ke,Rr,ke.variantStyle);C("simplified-pricing-express",Se,_t,Se.variantStyle);C("full-pricing-express",Ce,Pt,Ce.variantStyle);C("mini",Ae,Fr,Ae.variantStyle);var Gi=(i,t,e)=>{try{let r=Br.get(i.variant);if(r||(r=new CSSStyleSheet,r.replaceSync(t.cssText),Br.set(i.variant,r)),e?.styleSheet&&e.styleSheet!==r){let a=i.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);a!==-1&&i.shadowRoot.adoptedStyleSheets.splice(a,1)}return i.shadowRoot.adoptedStyleSheets.includes(r)||i.shadowRoot.adoptedStyleSheets.push(r),{styleSheet:r}}catch{let a=document.createElement("style");a.textContent=t.cssText,a.setAttribute("data-variant-style",i.variant);let n=e?.styleElement||i.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),i.shadowRoot.appendChild(a),{styleElement:a}}},Mt=i=>{let t=ht.get(i.variant);if(!t)return;let{class:e,style:r}=t,a=Ir.get(i);if(a?.appliedVariant===i.variant)return new e(i);let n=r?Gi(i,r,a):{};return Ir.set(i,{appliedVariant:i.variant,...n}),new e(i)};function ot(i){return ht.get(i)?.fragmentMapping}function Hr(i){return ht.get(i)?.collectionOptions}var qr=document.createElement("style");qr.innerHTML=`
:root {
...
`;document.head.appendChild(qr);function mt(i,t={},{metadata:e=!0,search:r=!0,storage:a=!0}={}){let n;if(r&&n==null){let o=new URLSearchParams(window.location.search),s=Rt(r)?r:i;n=o.get(s)}if(a&&n==null){let o=Rt(a)?a:i;n=window.sessionStorage.getItem(o)??window.localStorage.getItem(o)}if(e&&n==null){let o=Wi(Rt(e)?e:i);n=document.documentElement.querySelector(`meta[name="${o}"]`)?.content}return n??t[i]}var Vi=i=>typeof i=="boolean",gt=i=>typeof i=="function";var Rt=i=>typeof i=="string";function Ur(i,t){if(Vi(i))return i;let e=String(i);return e==="1"||e==="true"?!0:e==="0"||e==="false"?!1:t}function Wi(i=""){return String(i).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,e,r)=>`${e}-${r}`).replace(/\W+/gu,"-").toLowerCase()}var te=class i extends Error{constructor(t,e,r){if(super(t,{cause:r}),this.name="MasError",e.response){let a=e.response.headers?.get(et);a&&(e.requestId=a),e.response.status&&(e.status=e.response.status,e.statusText=e.response.statusText),e.response.url&&(e.url=e.response.url)}delete e.response,this.context=e,Error.captureStackTrace&&Error.captureStackTrace(this,i)}toString(){let t=Object.entries(this.context||{}).map(([r,a])=>`${r}: ${JSON.stringify(a)}`).join(", "),e=`${this.name}: ${this.message}`;return t&&(e+=` (${t})`),this.cause&&(e+=`
Caused by: ${this.cause}`),e}};var re={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals","element"],serializableTypes:["Array","Object"],sampleRate:1,severity:"e",tags:"acom",isProdDomain:!1},jr=1e3;function Yi(i){return i instanceof Error||typeof i?.originatingRequest=="string"}function Gr(i){if(i==null)return;let t=typeof i;if(t==="function")return i.name?`function ${i.name}`:"function";if(t==="object"){if(i instanceof Error)return i.message;if(typeof i.originatingRequest=="string"){let{message:r,originatingRequest:a,status:n}=i;return[r,n,a].filter(Boolean).join(" ")}let e=i[Symbol.toStringTag]??Object.getPrototypeOf(i).constructor.name;if(!re.serializableTypes.includes(e))return e}return i}function Ki(i,t){if(!re.ignoredProperties.includes(i))return Gr(t)}var Ot={append(i){if(i.level!=="error")return;let{message:t,params:e}=i,r=[],a=[],n=t;e.forEach(p=>{p!=null&&(Yi(p)?r:a).push(p)}),r.length&&(n+=" "+r.map(Gr).join(" "));let{pathname:o,search:s}=window.location,l=`${re.delimiter}page=${o}${s}`;l.length>jr&&(l=`${l.slice(0,jr)}<trunc>`),n+=l,a.length&&(n+=`${re.delimiter}facts=`,n+=JSON.stringify(a,Ki)),window.lana?.log(n,re)}};function Vr(i){Object.assign(re,Object.fromEntries(Object.entries(i).filter(([t,e])=>t in re&&e!==""&&e!==null&&e!==void 0&&!Number.isNaN(e))))}var Wr={LOCAL:"local",PROD:"prod",STAGE:"stage"},Dt={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},$t=new Set,Nt=new Set,Yr=new Map,Kr={append({level:i,message:t,params:e,timestamp:r,source:a}){console[i](`${r}ms [${a}] %c${t}`,"font-weight: bold;",...e)}},Qr={filter:({level:i})=>i!==Dt.DEBUG},Qi={filter:()=>!1};function Xi(i,t,e,r,a){return{level:i,message:t,namespace:e,get params(){return r.length===1&&gt(r[0])&&(r=r[0](),Array.isArray(r)||(r=[r])),r},source:a,timestamp:performance.now().toFixed(3)}}function Zi(i){[...Nt].every(t=>t(i))&&$t.forEach(t=>t(i))}function Xr(i){let t=(Yr.get(i)??0)+1;Yr.set(i,t);let e=`${i} #${t}`,r={id:e,namespace:i,module:a=>Xr(`${r.namespace}/${a}`),updateConfig:Vr};return Object.values(Dt).forEach(a=>{r[a]=(n,...o)=>Zi(Xi(a,n,i,o,e))}),Object.seal(r)}function ut(...i){i.forEach(t=>{let{append:e,filter:r}=t;gt(r)&&Nt.add(r),gt(e)&&$t.add(e)})}function Ji(i={}){let{name:t}=i,e=Ur(mt("commerce.debug",{search:!0,storage:!0}),t===Wr.LOCAL);return ut(e?Kr:Qr),t===Wr.PROD&&ut(Ot),Ue}function ea(){$t.clear(),Nt.clear()}var Ue={...Xr(gr),Level:Dt,Plugins:{consoleAppender:Kr,debugFilter:Qr,quietFilter:Qi,lanaAppender:Ot},init:Ji,reset:ea,use:ut};var ta="mas-commerce-service",qs=Ue.module("utilities"),ra={requestId:et,etag:"Etag",lastModified:"Last-Modified",serverTiming:"server-timing"};var ft=i=>window.setTimeout(i);function Ft(){return document.getElementsByTagName(ta)?.[0]}function Zr(i){let t={};if(!i?.headers)return t;let e=i.headers;for(let[r,a]of Object.entries(ra)){let n=e.get(a);n&&(n=n.replace(/[,;]/g,"|"),n=n.replace(/[| ]+/g,"|"),t[r]=n)}return t}async function Jr(i,t={},e=2,r=100){let a;for(let n=0;n<=e;n++)try{let o=await fetch(i,t);return o.retryCount=n,o}catch(o){if(a=o,a.retryCount=n,n>e)break;await new Promise(s=>setTimeout(s,r*(n+1)))}throw a}var ei="fragment",ti="author",ri="preview",ii="loading",ai="timeout",It="aem-fragment",ni="eager",oi="cache",ia=[ni,oi],I,ie,D,Bt=class{constructor(){g(this,I,new Map);g(this,ie,new Map);g(this,D,new Map)}clear(){c(this,I).clear(),c(this,ie).clear(),c(this,D).clear()}add(t,e=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(c(this,I).set(t.id,t),t.fields?.originalId&&c(this,I).set(t.fields.originalId,t),c(this,D).has(t.id)){let[,r]=c(this,D).get(t.id);r()}if(c(this,D).has(t.fields?.originalId)){let[,r]=c(this,D).get(t.fields?.originalId);r()}if(!(!e||typeof t.references!="object"||Array.isArray(t.references)))for(let r in t.references){let{type:a,value:n}=t.references[r];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return c(this,I).has(t)}entries(){return c(this,I).entries()}get(t){return c(this,I).get(t)}getAsPromise(t){let[e]=c(this,D).get(t)??[];if(e)return e;let r;return e=new Promise(a=>{r=a,this.has(t)&&a()}),c(this,D).set(t,[e,r]),e}getFetchInfo(t){let e=c(this,ie).get(t);return e||(e={url:null,retryCount:0,stale:!1,measure:null,status:null},c(this,ie).set(t,e)),e}remove(t){c(this,I).delete(t),c(this,ie).delete(t),c(this,D).delete(t)}};I=new WeakMap,ie=new WeakMap,D=new WeakMap;var K=new Bt,Te,$,U,R,_,k,je,Ge,N,Ve,We,Le,F,si,ci,Ht,li,xt=class extends HTMLElement{constructor(){super(...arguments);g(this,F);d(this,"cache",K);g(this,Te);g(this,$,null);g(this,U,null);g(this,R,null);g(this,_);g(this,k);g(this,je,ni);g(this,Ge,5e3);g(this,N);g(this,Ve,!1);g(this,We,0);g(this,Le)}static get observedAttributes(){return[ei,ii,ai,ti,ri]}attributeChangedCallback(e,r,a){e===ei&&(m(this,_,a),m(this,k,K.getFetchInfo(a))),e===ii&&ia.includes(a)&&m(this,je,a),e===ai&&m(this,Ge,parseInt(a,10)),e===ti&&m(this,Ve,["","true"].includes(a)),e===ri&&m(this,Le,a)}connectedCallback(){if(!c(this,N)){if(c(this,R)??m(this,R,J(this)),m(this,Le,c(this,R).settings?.preview),c(this,Te)??m(this,Te,c(this,R).log.module(`${It}[${c(this,_)}]`)),!c(this,_)||c(this,_)==="#"){c(this,k)??m(this,k,K.getFetchInfo("missing-fragment-id")),S(this,F,Ht).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(c(this,k)).filter(([e,r])=>r!=null).map(([e,r])=>[`aem-fragment:${e}`,r]))}async refresh(e=!0){if(c(this,N)&&!await Promise.race([c(this,N),Promise.resolve(!1)]))return;e&&K.remove(c(this,_)),c(this,je)===oi&&await Promise.race([K.getAsPromise(c(this,_)),new Promise(s=>setTimeout(s,c(this,Ge)))]);try{m(this,N,S(this,F,li).call(this)),await c(this,N)}catch(s){return S(this,F,Ht).call(this,s.message),!1}let{references:r,referencesTree:a,placeholders:n,wcs:o}=c(this,$)||{};return o&&!mt("mas.disableWcsCache")&&c(this,R).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(he,{detail:{...this.data,references:r,referencesTree:a,placeholders:n,...c(this,k)},bubbles:!0,composed:!0})),c(this,N)}get updateComplete(){return c(this,N)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return c(this,U)?c(this,U):(c(this,Ve)?this.transformAuthorData():this.transformPublishData(),c(this,U))}get rawData(){return c(this,$)}transformAuthorData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:l={}}=c(this,$);m(this,U,e.reduce((p,{name:h,multiple:v,values:P})=>(p.fields[h]=v?P:P[0],p),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:l}))}transformPublishData(){let{fields:e,id:r,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:l={}}=c(this,$);m(this,U,Object.entries(e).reduce((p,[h,v])=>(p.fields[h]=v?.mimeType?v.value:v??"",p),{fields:{},id:r,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:l}))}getFragmentClientUrl(){let r=new URLSearchParams(window.location.search).get("maslibs");if(!r||r.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=r.trim().toLowerCase();if(a==="local")return"http://localhost:3030/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let e=this.getFragmentClientUrl(),{previewFragment:r}=await import(e);return await r(c(this,_),{locale:c(this,R).settings.locale,apiKey:c(this,R).settings.wcsApiKey})}};Te=new WeakMap,$=new WeakMap,U=new WeakMap,R=new WeakMap,_=new WeakMap,k=new WeakMap,je=new WeakMap,Ge=new WeakMap,N=new WeakMap,Ve=new WeakMap,We=new WeakMap,Le=new WeakMap,F=new WeakSet,si=async function(e){Xt(this,We)._++;let r=`${It}:${c(this,_)}:${c(this,We)}`,a=`${r}${tt}`,n=`${r}${rt}`;if(c(this,Le))return await this.generatePreview();performance.mark(a);let o;try{if(c(this,k).stale=!1,c(this,k).url=e,o=await Jr(e,{cache:"default",credentials:"omit"}),S(this,F,ci).call(this,o),c(this,k).status=o?.status,c(this,k).measure=ge(performance.measure(n,a)),c(this,k).retryCount=o.retryCount,!o?.ok)throw new te("Unexpected fragment response",{response:o,...c(this,R).duration});return await o.json()}catch(s){if(c(this,k).measure=ge(performance.measure(n,a)),c(this,k).retryCount=s.retryCount,c(this,$))return c(this,k).stale=!0,c(this,Te).error("Serving stale data",c(this,k)),c(this,$);let l=s.message??"unknown";throw new te(`Failed to fetch fragment: ${l}`,{})}},ci=function(e){Object.assign(c(this,k),Zr(e))},Ht=function(e){m(this,N,null),c(this,k).message=e,this.classList.add("error");let r={...c(this,k),...c(this,R).duration};c(this,Te).error(e,r),this.dispatchEvent(new CustomEvent(me,{detail:r,bubbles:!0,composed:!0}))},li=async function(){var l;this.classList.remove("error"),m(this,U,null);let e=K.get(c(this,_));if(e)return m(this,$,e),!0;let{masIOUrl:r,wcsApiKey:a,country:n,locale:o}=c(this,R).settings,s=`${r}/fragment?id=${c(this,_)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),e=await S(this,F,si).call(this,s),(l=e.fields).originalId??(l.originalId=c(this,_)),K.add(e),m(this,$,e),!0},d(xt,"cache",K);customElements.define(It,xt);import{LitElement as aa,html as qt,css as na,nothing as oa}from"./lit-all.min.js";import{unsafeHTML as sa}from"./lit-all.min.js";var ca=i=>i?i.startsWith("sp-icon-")?qt`${sa(`<${i} class="badge-icon"></${i}>`)}`:qt`<img src="${i}" class="badge-icon" />`:oa,ze=class extends aa{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="";let t=this.closest("merch-card"),e=t?.getAttribute("size"),r=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",r),this.style.setProperty("--merch-badge-with-offset",r?1:0),this.style.setProperty("--merch-badge-card-size",e?2:1),super.connectedCallback()}render(){return qt`<div class="badge">
            ${ca(this.icon)}${this.text}
        </div>`}};d(ze,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"},icon:{type:String}}),d(ze,"styles",na`
        :host {
            display: block;
    ...
    `);customElements.define("merch-badge",ze);import{html as la,css as da,LitElement as pa}from"./lit-all.min.js";var Ye=class extends pa{constructor(){super()}render(){return la`
            <slot name="icon"></slot>
    ...
    `),d(Ye,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",Ye);import{html as Ut,css as ha,LitElement as ma,nothing as di}from"./lit-all.min.js";var Ke=class extends ma{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,e)=>{e>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return Ut`<slot name="heading"></slot>
            <slot name="contentBullets"></slot>
            ${!this.isMobile||!this.bulletsAdded?Ut`<slot name="content"></slot>`:di}
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?Ut`<div @click=${this.toggle} class="see-more">
                      ${this.showAll?"- See less":"+ See more"}
                  </div>`:di}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};d(Ke,"styles",ha`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
    ...
    `),d(Ke,"properties",{heading:{type:String,attribute:!0},mobileRows:{type:Number,attribute:!0}});customElements.define("merch-whats-included",Ke);var ga={[V]:dr,[Z]:pr,[W]:hr},ua={[V]:mr,[W]:De},Qe,vt=class{constructor(t){g(this,Qe);d(this,"changes",new Map);d(this,"connected",!1);d(this,"error");d(this,"log");d(this,"options");d(this,"promises",[]);d(this,"state",Z);d(this,"timer",null);d(this,"value");d(this,"version",0);d(this,"wrapperElement");this.wrapperElement=t,this.log=Ue.module("mas-element")}update(){[V,Z,W].forEach(t=>{this.wrapperElement.classList.toggle(ga[t],t===this.state)})}notify(){(this.state===W||this.state===V)&&(this.state===W?this.promises.forEach(({resolve:e})=>e(this.wrapperElement)):this.state===V&&this.promises.forEach(({reject:e})=>e(this.error)),this.promises=[]);let t=this.error;this.error instanceof te&&(t={message:this.error.message,...this.error.context}),this.wrapperElement.dispatchEvent(new CustomEvent(ua[this.state],{bubbles:!0,composed:!0,detail:t}))}attributeChangedCallback(t,e,r){this.changes.set(t,r),this.requestUpdate()}connectedCallback(){m(this,Qe,Ft()),this.requestUpdate(!0)}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement}))}onceSettled(){let{error:t,promises:e,state:r}=this;return W===r?Promise.resolve(this.wrapperElement):V===r?Promise.reject(t):new Promise((a,n)=>{e.push({resolve:a,reject:n})})}toggleResolved(t,e,r){return t!==this.version?!1:(r!==void 0&&(this.options=r),this.state=W,this.value=e,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:e}),ft(()=>this.notify()),!0)}toggleFailed(t,e,r){if(t!==this.version)return!1;r!==void 0&&(this.options=r),this.error=e,this.state=V,this.update();let a=this.wrapperElement.getAttribute("is");return this.log?.error(`${a}: Failed to render: ${e.message}`,{element:this.wrapperElement,...e.context,...c(this,Qe)?.duration}),ft(()=>this.notify()),!0}togglePending(t){return this.version++,t&&(this.options=t),this.state=Z,this.update(),this.log?.debug("Pending:",{osi:this.wrapperElement?.options?.wcsOsi}),this.version}requestUpdate(t=!1){if(!this.wrapperElement.isConnected||!Ft()||this.timer)return;let{error:e,options:r,state:a,value:n,version:o}=this;this.state=Z,this.timer=ft(async()=>{this.timer=null;let s=null;if(this.changes.size&&(s=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:s}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:s})),s||t)try{await this.wrapperElement.render?.()===!1&&this.state===Z&&this.version===o&&(this.state=a,this.error=e,this.value=n,this.update(),this.notify())}catch(l){this.toggleFailed(this.version,l,r)}})}};Qe=new WeakMap;function fa(i){return`https://${i==="PRODUCTION"?"www.adobe.com":"www.stage.adobe.com"}/offers/promo-terms.html`}var ne,ae=class ae extends HTMLAnchorElement{constructor(){super();d(this,"masElement",new vt(this));g(this,ne);this.setAttribute("is",ae.is)}get isUptLink(){return!0}initializeWcsData(e,r){this.setAttribute("data-wcs-osi",e),r&&this.setAttribute("data-promotion-code",r)}attributeChangedCallback(e,r,a){this.masElement.attributeChangedCallback(e,r,a)}connectedCallback(){this.masElement.connectedCallback(),m(this,ne,J()),c(this,ne)&&(this.log=c(this,ne).log.module("upt-link"))}disconnectedCallback(){this.masElement.disconnectedCallback(),m(this,ne,void 0)}requestUpdate(e=!1){this.masElement.requestUpdate(e)}onceSettled(){return this.masElement.onceSettled()}async render(){let e=J();if(!e)return!1;this.dataset.imsCountry||e.imsCountryPromise.then(o=>{o&&(this.dataset.imsCountry=o)});let r=e.collectCheckoutOptions({},this);if(!r.wcsOsi)return this.log.error("Missing 'data-wcs-osi' attribute on upt-link."),!1;let a=this.masElement.togglePending(r),n=e.resolveOfferSelectors(r);try{let[[o]]=await Promise.all(n),{country:s,language:l,env:p}=r,h=`locale=${l}_${s}&country=${s}&offer_id=${o.offerId}`,v=this.getAttribute("data-promotion-code");v&&(h+=`&promotion_code=${encodeURIComponent(v)}`),this.href=`${fa(p)}?${h}`,this.masElement.toggleResolved(a,o,r)}catch(o){let s=new Error(`Could not resolve offer selectors for id: ${r.wcsOsi}.`,o.message);return this.masElement.toggleFailed(a,s,r),!1}}static createFrom(e){let r=new ae;for(let a of e.attributes)a.name!=="is"&&(a.name==="class"&&a.value.includes("upt-link")?r.setAttribute("class",a.value.replace("upt-link","").trim()):r.setAttribute(a.name,a.value));return r.innerHTML=e.innerHTML,r.setAttribute("tabindex",0),r}};ne=new WeakMap,d(ae,"is","upt-link"),d(ae,"tag","a"),d(ae,"observedAttributes",["data-wcs-osi","data-promotion-code","data-ims-country"]);var Q=ae;window.customElements.get(Q.is)||window.customElements.define(Q.is,Q,{extends:Q.tag});var xa="#000000",jt="#F8D904",va="#EAEAEA",ba="#31A547",ya=/(accent|primary|secondary)(-(outline|link))?/,wa="mas:product_code/",Ea="daa-ll",bt="daa-lh",ka=["XL","L","M","S"],Gt="...";function O(i,t,e,r){let a=r[i];if(t[i]&&a){let n={slot:a?.slot,...a?.attributes},o=t[i];if(a.maxCount&&typeof o=="string"){let[l,p]=Ba(o,a.maxCount,a.withSuffix);l!==o&&(n.title=p,o=l)}let s=L(a.tag,n,o);e.append(s)}}function Sa(i,t,e){let a=(i.mnemonicIcon||[]).filter(o=>o).map((o,s)=>({icon:o,alt:i.mnemonicAlt?.[s]??"",link:i.mnemonicLink?.[s]??""}));a?.forEach(({icon:o,alt:s,link:l})=>{if(l&&!/^https?:/.test(l))try{l=new URL(`https://${l}`).href.toString()}catch{l="#"}let p={slot:"icons",src:o,loading:t.loading,size:e?.size??"l"};s&&(p.alt=s),l&&(p.href=l);let h=L("merch-icon",p);t.append(h)});let n=t.shadowRoot.querySelector('slot[name="icons"]');n&&(n.style.display=a?.length?null:"none")}function Ca(i,t,e){if(e.badge?.slot){if(i.badge?.length&&!i.badge?.startsWith("<merch-badge")){let r=jt,a=!1;e.allowedBadgeColors?.includes(e.badge?.default)&&(r=e.badge?.default,i.borderColor||(a=!0));let n=i.badgeBackgroundColor||r,o=i.borderColor||"";a&&(o=e.badge?.default,i.borderColor=e.badge?.default),i.badge=`<merch-badge variant="${i.variant}" background-color="${n}" border-color="${o}">${i.badge}</merch-badge>`}O("badge",i,t,e)}else i.badge?(t.setAttribute("badge-text",i.badge),e.disabledAttributes?.includes("badgeColor")||t.setAttribute("badge-color",i.badgeColor||xa),e.disabledAttributes?.includes("badgeBackgroundColor")||t.setAttribute("badge-background-color",i.badgeBackgroundColor||jt),t.setAttribute("border-color",i.badgeBackgroundColor||jt)):t.setAttribute("border-color",i.borderColor||va)}function Aa(i,t,e){if(e.trialBadge&&i.trialBadge){if(!i.trialBadge.startsWith("<merch-badge")){let r=!e.disabledAttributes?.includes("trialBadgeBorderColor")&&i.trialBadgeBorderColor||ba;i.trialBadge=`<merch-badge variant="${i.variant}" border-color="${r}">${i.trialBadge}</merch-badge>`}O("trialBadge",i,t,e)}}function Ta(i,t,e){e?.includes(i.size)&&t.setAttribute("size",i.size)}function La(i,t){i.cardName&&t.setAttribute("name",i.cardName)}function za(i,t,e){i.cardTitle&&(i.cardTitle=_e(i.cardTitle)),O("cardTitle",i,t,{cardTitle:e})}function _a(i,t,e){O("subtitle",i,t,e)}function Pa(i,t,e,r){if(!i.backgroundColor||i.backgroundColor.toLowerCase()==="default"){t.style.removeProperty("--merch-card-custom-background-color"),t.removeAttribute("background-color");return}e?.[i.backgroundColor]?(t.style.setProperty("--merch-card-custom-background-color",`var(${e[i.backgroundColor]})`),t.setAttribute("background-color",i.backgroundColor)):r?.attribute&&i.backgroundColor&&(t.setAttribute(r.attribute,i.backgroundColor),t.style.removeProperty("--merch-card-custom-background-color"))}function Ma(i,t,e){let r=e?.borderColor,a="--consonant-merch-card-border-color";if(i.borderColor?.toLowerCase()==="transparent")t.style.setProperty(a,"transparent");else if(i.borderColor&&r){let o=r?.specialValues?.[i.borderColor]?.includes("gradient")||/-gradient/.test(i.borderColor),s=/^spectrum-.*-(plans|special-offers)$/.test(i.borderColor);if(o){t.setAttribute("gradient-border","true");let l=i.borderColor;if(r?.specialValues){for(let[p,h]of Object.entries(r.specialValues))if(h===i.borderColor){l=p;break}}t.setAttribute("border-color",l),t.style.removeProperty(a)}else s?(t.setAttribute("border-color",i.borderColor),t.style.setProperty(a,`var(--${i.borderColor})`)):t.style.setProperty(a,`var(--${i.borderColor})`)}}function Ra(i,t,e){if(i.backgroundImage){let r={loading:t.loading??"lazy",src:i.backgroundImage};if(i.backgroundImageAltText?r.alt=i.backgroundImageAltText:r.role="none",!e)return;if(e?.attribute){t.setAttribute(e.attribute,i.backgroundImage);return}t.append(L(e.tag,{slot:e.slot},L("img",r)))}}function _e(i){return!i||typeof i!="string"||i.includes("<mas-mnemonic")&&Promise.resolve().then(()=>(kt(),Et)).catch(console.error),i}function Oa(i,t,e){i.prices&&(i.prices=_e(i.prices)),O("prices",i,t,e)}function hi(i,t,e){let r=i.hasAttribute("data-wcs-osi")&&!!i.getAttribute("data-wcs-osi"),a=i.className||"",n=ya.exec(a)?.[0]??"accent",o=n.includes("accent"),s=n.includes("primary"),l=n.includes("secondary"),p=n.includes("-outline"),h=n.includes("-link");i.classList.remove("accent","primary","secondary");let v;if(t.consonant)v=ja(i,o,r,h,s,l);else if(h)v=i;else{let P;o?P="accent":s?P="primary":l&&(P="secondary"),v=t.spectrum==="swc"?Ua(i,e,p,P,r):qa(i,e,p,P,r)}return v}function Da(i,t){let{slot:e}=t?.description,r=i.querySelectorAll(`[slot="${e}"] a[data-wcs-osi]`);r.length&&r.forEach(a=>{let n=hi(a,i,t);a.replaceWith(n)})}function $a(i,t,e){i.description&&(i.description=_e(i.description)),i.promoText&&(i.promoText=_e(i.promoText)),i.shortDescription&&(i.shortDescription=_e(i.shortDescription)),O("promoText",i,t,e),O("description",i,t,e),O("shortDescription",i,t,e),i.shortDescription&&(t.setAttribute("action-menu","true"),i.actionMenuLabel||t.setAttribute("action-menu-label","More options")),Da(t,e),O("callout",i,t,e),O("quantitySelect",i,t,e),O("whatsIncluded",i,t,e)}function Na(i,t,e){if(!e.addon)return;let r=i.addon?.replace(/[{}]/g,"");if(!r||/disabled/.test(r))return;let a=L("merch-addon",{slot:"addon"},r);[...a.querySelectorAll(w)].forEach(n=>{let o=n.parentElement;o?.nodeName==="P"&&o.setAttribute("data-plan-type","")}),t.append(a)}function Fa(i,t,e){i.addonConfirmation&&O("addonConfirmation",i,t,e)}function Ia(i,t,e,r){r?.secureLabel&&e?.secureLabel&&t.setAttribute("secure-label",r.secureLabel)}function Ba(i,t,e=!0){try{let r=typeof i!="string"?"":i,a=pi(r);if(a.length<=t)return[r,a];let n=0,o=!1,s=e?t-Gt.length<1?1:t-Gt.length:t,l=[];for(let v of r){if(n++,v==="<")if(o=!0,r[n]==="/")l.pop();else{let P="";for(let le of r.substring(n)){if(le===" "||le===">")break;P+=le}l.push(P)}if(v==="/"&&r[n]===">"&&l.pop(),v===">"){o=!1;continue}if(!o&&(s--,s===0))break}let p=r.substring(0,n).trim();if(l.length>0){l[0]==="p"&&l.shift();for(let v of l.reverse())p+=`</${v}>`}return[`${p}${e?Gt:""}`,a]}catch{let a=typeof i=="string"?i:"",n=pi(a);return[a,n]}}function pi(i){if(!i)return"";let t="",e=!1;for(let r of i){if(r==="<"&&(e=!0),r===">"){e=!1;continue}e||(t+=r)}return t}function Ha(i,t){t.querySelectorAll("a.upt-link").forEach(r=>{let a=Q.createFrom(r);r.replaceWith(a),a.initializeWcsData(i.osi,i.promoCode)})}function qa(i,t,e,r,a){let n=i;a?n=customElements.get("checkout-button").createCheckoutButton({},i.innerHTML):n.innerHTML=`<span>${n.textContent}</span>`,n.setAttribute("tabindex",0);for(let h of i.attributes)["class","is"].includes(h.name)||n.setAttribute(h.name,h.value);n.firstElementChild?.classList.add("spectrum-Button-label");let o=t?.ctas?.size??"M",s=`spectrum-Button--${r}`,l=ka.includes(o)?`spectrum-Button--size${o}`:"spectrum-Button--sizeM",p=["spectrum-Button",s,l];return e&&p.push("spectrum-Button--outline"),n.classList.add(...p),n}function Ua(i,t,e,r,a){let n=i;a&&(n=customElements.get("checkout-button").createCheckoutButton(i.dataset),n.connectedCallback(),n.render());let o="fill";e&&(o="outline");let s=L("sp-button",{treatment:o,variant:r,tabIndex:0,size:t?.ctas?.size??"m",...i.dataset.analyticsId&&{"data-analytics-id":i.dataset.analyticsId}},i.innerHTML);return s.source=n,(a?n.onceSettled():Promise.resolve(n)).then(l=>{s.setAttribute("data-navigation-url",l.href)}),s.addEventListener("click",l=>{l.defaultPrevented||n.click()}),s}function ja(i,t,e,r,a,n){let o=i;return e&&(o=customElements.get("checkout-link").createCheckoutLink(i.dataset,i.innerHTML)),r||(o.classList.add("button","con-button"),t&&o.classList.add("blue"),a&&o.classList.add("primary"),n&&o.classList.add("secondary")),o}function Ga(i,t,e,r){if(i.ctas){i.ctas=_e(i.ctas);let{slot:a}=e.ctas,n=L("div",{slot:a},i.ctas),o=[...n.querySelectorAll("a")].map(s=>hi(s,t,e));n.innerHTML="",n.append(...o),t.append(n)}}function Va(i,t){let{tags:e}=i,r=e?.find(n=>typeof n=="string"&&n.startsWith(wa))?.split("/").pop();if(!r)return;t.setAttribute(bt,r),[...t.shadowRoot.querySelectorAll("a[data-analytics-id],button[data-analytics-id]"),...t.querySelectorAll("a[data-analytics-id],button[data-analytics-id]")].forEach((n,o)=>{n.setAttribute(Ea,`${n.dataset.analyticsId}-${o+1}`)})}function Wa(i){i.spectrum==="css"&&[["primary-link","primary"],["secondary-link","secondary"]].forEach(([t,e])=>{i.querySelectorAll(`a.${t}`).forEach(r=>{r.classList.remove(t),r.classList.add("spectrum-Link",`spectrum-Link--${e}`)})})}function Ya(i){i.querySelectorAll("[slot]").forEach(r=>{r.remove()}),i.variant=void 0,["checkbox-label","stock-offer-osis","secure-label","background-image","background-color","border-color","badge-background-color","badge-color","badge-text","gradient-border","size",bt].forEach(r=>i.removeAttribute(r));let e=["wide-strip","thin-strip"];i.classList.remove(...e)}async function mi(i,t){if(!i){let l=t?.id||"unknown";throw console.error(`hydrate: Fragment is undefined. Cannot hydrate card (merchCard id: ${l}).`),new Error(`hydrate: Fragment is undefined for card (merchCard id: ${l}).`)}if(!i.fields){let l=i.id||"unknown",p=t?.id||"unknown";throw console.error(`hydrate: Fragment for card ID '${l}' (merchCard id: ${p}) is missing 'fields'. Cannot hydrate.`),new Error(`hydrate: Fragment for card ID '${l}' (merchCard id: ${p}) is missing 'fields'.`)}let{id:e,fields:r,settings:a={},priceLiterals:n}=i,{variant:o}=r;if(!o)throw new Error(`hydrate: no variant found in payload ${e}`);Ya(t),t.settings=a,n&&(t.priceLiterals=n),t.id??(t.id=i.id),t.variant=o,await t.updateComplete;let{aemFragmentMapping:s}=t.variantLayout;if(!s)throw new Error(`hydrate: variant mapping not found for ${e}`);s.style==="consonant"&&t.setAttribute("consonant",!0),Sa(r,t,s.mnemonics),Ca(r,t,s),Aa(r,t,s),Ta(r,t,s.size),La(r,t),za(r,t,s.title),_a(r,t,s),Oa(r,t,s),Ra(r,t,s.backgroundImage),Pa(r,t,s.allowedColors,s.backgroundColor),Ma(r,t,s),$a(r,t,s),Na(r,t,s),Fa(r,t,s),Ia(r,t,s,a),Ha(r,t),Ga(r,t,s,o),Va(r,t),Wa(t)}var Yt="merch-card",Vt=2e4,gi="merch-card:",Qa=["full-pricing-express","simplified-pricing-express"];function ui(i,t){let e=i.closest(Yt);if(!e)return t;e.priceLiterals&&(t.literals??(t.literals={}),Object.assign(t.literals,e.priceLiterals)),e.aemFragment&&(t[ur]=!0),e.variantLayout?.priceOptionsProvider?.(i,t)}function Xa(i){i.providers.has(ui)||i.providers.price(ui)}var fi=new IntersectionObserver(i=>{i.forEach(t=>{t.target.clientHeight!==0&&(fi.unobserve(t.target),t.target.requestUpdate())})}),Za=0,Pe,Me,Re,j,se,B,ce,E,oe,Xe,Wt,yt,X=class extends Ka{constructor(){super();g(this,E);g(this,Pe);g(this,Me);g(this,Re);g(this,j);g(this,se);g(this,B);g(this,ce,new Promise(e=>{m(this,B,e)}));d(this,"customerSegment");d(this,"marketSegment");d(this,"variantLayout");this.id=null,this.failed=!1,this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.loading="lazy",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this),this.handleMerchOfferSelectReady=this.handleMerchOfferSelectReady.bind(this)}firstUpdated(){this.variantLayout=Mt(this),this.variantLayout?.connectedCallbackHook()}willUpdate(e){(e.has("variant")||!this.variantLayout)&&(this.variantLayout?.disconnectedCallbackHook(),this.variantLayout=Mt(this),this.variantLayout?.connectedCallbackHook())}updated(e){(e.has("badgeBackgroundColor")||e.has("borderColor"))&&this.style.setProperty("--consonant-merch-card-border",this.computedBorderStyle),e.has("backgroundColor")&&this.style.setProperty("--merch-card-custom-background-color",this.backgroundColor?`var(--${this.backgroundColor})`:"");try{this.variantLayoutPromise=this.variantLayout?.postCardUpdateHook(e)}catch(r){S(this,E,oe).call(this,`Error in postCardUpdateHook: ${r.message}`,{},!1)}}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderStyle(){return["ccd-slice","ccd-suggested","ah-promoted-plans","simplified-pricing-express","full-pricing-express"].includes(this.variant)?"":`1px solid ${this.borderColor?this.borderColor:this.badgeBackgroundColor}`}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get descriptionSlot(){return this.shadowRoot.querySelector('slot[name="body-xs"')?.assignedElements()[0]}get descriptionSlotCompare(){return this.shadowRoot.querySelector('slot[name="body-m"')?.assignedElements()[0]}get price(){return this.headingmMSlot?.querySelector(w)}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll(G)??[]]}get checkoutLinksDescription(){return[...this.descriptionSlot?.querySelectorAll(G)??[]]}get checkoutLinkDescriptionCompare(){return[...this.descriptionSlotCompare?.querySelectorAll(G)??[]]}get activeDescriptionLinks(){return this.variant==="mini-compare-chart"?this.checkoutLinkDescriptionCompare:this.checkoutLinksDescription}async toggleStockOffer({target:e}){if(!this.stockOfferOsis)return;let r=this.checkoutLinks;if(r.length!==0)for(let a of r){await a.onceSettled();let n=a.value?.[0]?.planType;if(!n)return;let o=this.stockOfferOsis[n];if(!o)return;let s=a.dataset.wcsOsi.split(",").filter(l=>l!==o);e.checked&&s.push(o),a.dataset.wcsOsi=s.join(",")}}changeHandler(e){e.target.tagName==="MERCH-ADDON"&&this.toggleAddon(e.target)}toggleAddon(e){this.variantLayout?.toggleAddon?.(e);let r=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(r.length===0)return;let a=n=>{let{offerType:o,planType:s}=n.value?.[0]??{};if(!o||!s)return;let l=e.getOsi(s,o),p=(n.dataset.wcsOsi||"").split(",").filter(h=>h&&h!==l);e.checked&&p.push(l),n.dataset.wcsOsi=p.join(",")};r.forEach(a)}handleQuantitySelection(e){let r=[...this.checkoutLinks,...this.activeDescriptionLinks??[]];if(r.length!==0)for(let a of r)a.dataset.quantity=e.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(e){let r={...this.filters};Object.keys(r).forEach(a=>{if(e){r[a].order=Math.min(r[a].order||2,2);return}let n=r[a].order;n===1||isNaN(n)||(r[a].order=Number(n)+1)}),this.filters=r}includes(e){return this.textContent.match(new RegExp(e,"i"))!==null}connectedCallback(){var r;super.connectedCallback(),c(this,Me)||m(this,Me,Za++),this.aemFragment||((r=c(this,B))==null||r.call(this),m(this,B,void 0)),this.id??(this.id=this.getAttribute("id")??this.aemFragment?.getAttribute("fragment"));let e=this.id??c(this,Me);m(this,se,`${gi}${e}${tt}`),m(this,Pe,`${gi}${e}${rt}`),performance.mark(c(this,se)),m(this,j,J()),Xa(c(this,j)),m(this,Re,c(this,j).Log.module(Yt)),this.addEventListener(H,this.handleQuantitySelection),this.addEventListener(St,this.handleAddonAndQuantityUpdate),this.addEventListener(nr,this.handleMerchOfferSelectReady),this.addEventListener(me,this.handleAemFragmentEvents),this.addEventListener(he,this.handleAemFragmentEvents),this.addEventListener("change",this.changeHandler),this.variantLayout&&this.variantLayout.connectedCallbackHook(),this.aemFragment||setTimeout(()=>this.checkReady(),0)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout?.disconnectedCallbackHook(),this.removeEventListener(H,this.handleQuantitySelection),this.removeEventListener(me,this.handleAemFragmentEvents),this.removeEventListener(he,this.handleAemFragmentEvents),this.removeEventListener("change",this.changeHandler),this.removeEventListener(St,this.handleAddonAndQuantityUpdate)}async handleAemFragmentEvents(e){var r;if(this.isConnected&&(e.type===me&&S(this,E,oe).call(this,"AEM fragment cannot be loaded"),e.type===he&&(this.failed=!1,e.target.nodeName==="AEM-FRAGMENT"))){let a=e.detail;try{c(this,B)||m(this,ce,new Promise(n=>{m(this,B,n)})),mi(a,this)}catch(n){S(this,E,oe).call(this,`hydration has failed: ${n.message}`)}finally{(r=c(this,B))==null||r.call(this),m(this,B,void 0)}this.checkReady()}}async checkReady(){if(!this.isConnected)return;c(this,ce)&&(await c(this,ce),Qa.includes(this.variant)&&fi.observe(this),m(this,ce,void 0)),this.variantLayoutPromise&&(await this.variantLayoutPromise,this.variantLayoutPromise=void 0);let e=new Promise(o=>setTimeout(()=>o("timeout"),Vt));if(this.aemFragment){let o=await Promise.race([this.aemFragment.updateComplete,e]);if(o===!1||o==="timeout"){let s=o==="timeout"?`AEM fragment was not resolved within ${Vt} timeout`:"AEM fragment cannot be loaded";S(this,E,oe).call(this,s,{},!1);return}}let r=[...this.querySelectorAll(ar)],a=Promise.all(r.map(o=>o.onceSettled().catch(()=>o))).then(o=>o.every(s=>s.classList.contains("placeholder-resolved"))),n=await Promise.race([a,e]);if(n===!0){this.measure=performance.measure(c(this,Pe),c(this,se));let o={...this.aemFragment?.fetchInfo,...c(this,j).duration,measure:ge(this.measure)};return this.dispatchEvent(new CustomEvent(cr,{bubbles:!0,composed:!0,detail:o})),this}else{this.measure=performance.measure(c(this,Pe),c(this,se));let o={measure:ge(this.measure),...c(this,j).duration};n==="timeout"?S(this,E,oe).call(this,`Contains offers that were not resolved within ${Vt} timeout`,o):S(this,E,oe).call(this,"Contains unresolved offers",o)}}get aemFragment(){return this.querySelector("aem-fragment")}get addon(){return this.querySelector("merch-addon")}get quantitySelect(){return this.querySelector("merch-quantity-select")}get addonCheckbox(){return this.querySelector("merch-addon")}displayFooterElementsInColumn(){if(!this.classList.contains("product"))return;let e=this.shadowRoot.querySelector(".secure-transaction-label");(this.footerSlot?.querySelectorAll(G)).length===2&&e&&e.parentElement.classList.add("footer-column")}handleMerchOfferSelectReady(){this.offerSelect&&!this.offerSelect.planType||this.displayFooterElementsInColumn()}get dynamicPrice(){return this.querySelector('[slot="price"]')}handleAddonAndQuantityUpdate({detail:{id:e,items:r}}){if(!e||!r?.length||this.closest('[role="tabpanel"][hidden="true"]'))return;let n=this.checkoutLinks.find(h=>h.getAttribute("data-modal-id")===e);if(!n)return;let s=new URL(n.getAttribute("href")).searchParams.get("pa"),l=r.find(h=>h.productArrangementCode===s)?.quantity,p=!!r.find(h=>h.productArrangementCode!==s);if(l&&this.quantitySelect?.dispatchEvent(new CustomEvent(sr,{detail:{quantity:l},bubbles:!0,composed:!0})),this.addonCheckbox&&this.addonCheckbox.checked!==p){this.toggleStockOffer({target:this.addonCheckbox});let h=new Event("change",{bubbles:!0,cancelable:!0});Object.defineProperty(h,"target",{writable:!1,value:{checked:p}}),this.addonCheckbox.handleChange(h)}}get prices(){return Array.from(this.querySelectorAll(w))}get promoPrice(){if(!this.querySelector("span.price-strikethrough"))return;let e=this.querySelector(".price.price-alternative");if(e||(e=this.querySelector(`${w}[data-template="price"] > span`)),!!e)return e=e.innerText,e}get regularPrice(){return c(this,E,Xe)?.innerText}get promotionCode(){let e=[...this.querySelectorAll(`${w}[data-promotion-code],${G}[data-promotion-code]`)].map(a=>a.dataset.promotionCode),r=[...new Set(e)];return r.length>1&&c(this,Re)?.warn(`Multiple different promotion codes found: ${r.join(", ")}`),e[0]}get annualPrice(){return this.querySelector(`${w}[data-template="price"] > .price.price-annual`)?.innerText}get promoText(){}get taxText(){return(c(this,E,Wt)??c(this,E,Xe))?.querySelector("span.price-tax-inclusivity")?.textContent?.trim()||void 0}get recurrenceText(){return c(this,E,Xe)?.querySelector("span.price-recurrence")?.textContent?.trim()}get unitText(){let e=".price-unit-type";return c(this,E,Wt)?.querySelector(e)?.textContent?.trim()??c(this,E,Xe)?.querySelector(e)?.textContent?.trim()??this.querySelector(e)?.textContent?.trim()??void 0}get planTypeText(){return this.querySelector('[is="inline-price"][data-template="legal"] span.price-plan-type')?.textContent?.trim()}get seeTermsInfo(){let e=this.querySelector('a[is="upt-link"]');if(e)return S(this,E,yt).call(this,e)}get renewalText(){return this.querySelector("span.renewal-text")?.textContent?.trim()}get promoDurationText(){return this.querySelector("span.promo-duration-text")?.textContent?.trim()}get ctas(){let e=this.querySelector('[slot="ctas"], [slot="footer"]')?.querySelectorAll(`${G}, a`);return Array.from(e??[])}get primaryCta(){return S(this,E,yt).call(this,this.ctas.find(e=>e.variant==="accent"||e.matches(".spectrum-Button--accent,.con-button.blue")))}get secondaryCta(){return S(this,E,yt).call(this,this.ctas.find(e=>e.variant!=="accent"&&!e.matches(".spectrum-Button--accent,.con-button.blue")))}};Pe=new WeakMap,Me=new WeakMap,Re=new WeakMap,j=new WeakMap,se=new WeakMap,B=new WeakMap,ce=new WeakMap,E=new WeakSet,oe=function(e,r={},a=!0){if(!this.isConnected)return;let o=this.aemFragment?.getAttribute("fragment");o=`[${o}]`;let s={...this.aemFragment.fetchInfo,...c(this,j).duration,...r,message:e};c(this,Re).error(`merch-card${o}: ${e}`,s),this.failed=!0,a&&this.dispatchEvent(new CustomEvent(lr,{bubbles:!0,composed:!0,detail:s}))},Xe=function(){return this.querySelector("span.price-strikethrough")??this.querySelector(`${w}[data-template="price"] > span`)},Wt=function(){return this.querySelector(`${w}[data-template="legal"]`)},yt=function(e){if(e)return{text:e.innerText.trim(),analyticsId:e.dataset.analyticsId,href:e.getAttribute("href")??e.dataset.href}},d(X,"properties",{id:{type:String,attribute:"id",reflect:!0},name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},backgroundColor:{type:String,attribute:"background-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},actionMenuLabel:{type:String,attribute:"action-menu-label"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},failed:{type:Boolean,attribute:"failed",reflect:!0},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},addonTitle:{type:String,attribute:"addon-title"},addonOffers:{type:Object,attribute:"addon-offers"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},settings:{type:Object,attribute:!1},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:e=>{if(!e)return;let[r,a,n]=e.split(",");return{PUF:r,ABM:a,M2M:n}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:e=>Object.fromEntries(e.split(",").map(r=>{let[a,n,o]=r.split(":"),s=Number(n);return[a,{order:isNaN(s)?void 0:s,size:o}]})),toAttribute:e=>Object.entries(e).map(([r,{order:a,size:n}])=>[r,a,n].filter(o=>o!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:bt,reflect:!0},loading:{type:String},priceLiterals:{type:Object}}),d(X,"styles",[tr,...rr()]),d(X,"registerVariant",C),d(X,"getCollectionOptions",Hr),d(X,"getFragmentMapping",ot);customElements.define(Yt,X);export{X as MerchCard};
