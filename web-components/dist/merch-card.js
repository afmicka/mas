...
`;var Ut={mnemonics:{size:"s"},title:{tag:"h3",slot:"heading-xxs",maxCount:250,withSuffix:!0},description:{tag:"div",slot:"body-s",maxCount:2e3,withSuffix:!1},whatsIncluded:{tag:"div",slot:"whats-included"},badge:{tag:"div",slot:"badge",default:"spectrum-yellow-300"},trialBadge:{tag:"div",slot:"trial-badge",default:"spectrum-green-800"},prices:{tag:"p",slot:"price"},ctas:{slot:"cta",size:"M"},addonConfirmation:{tag:"div",slot:"addon-confirmation"},borderColor:{attribute:"border-color",specialValues:{gray:"--spectrum-gray-300","gradient-purple-blue":"var(--gradient-purple-blue)","gradient-firefly-spectrum":"var(--gradient-firefly-spectrum)"}}},Re=class extends x{getGlobalCSS(){return ca}get aemFragmentMapping(){return Ut}renderLayout(){return Ai`
    ...
    `);var wt=new Map,sa=new WeakMap,la=new Map,E=(a,t,e=null,r=null,i)=>{wt.set(a,{class:t,fragmentMapping:e,style:r,collectionOptions:i})};E("catalog",Ee,zr,Ee.variantStyle);E("image",oe);E("inline-heading",ft);E("mini-compare-chart",ke,Dr,ke.variantStyle);E("mini-compare-chart-mweb",Se,$r,Se.variantStyle);E("plans",_,bt,_.variantStyle,_.collectionOptions);E("plans-students",_,Hr,_.variantStyle,_.collectionOptions);E("plans-education",_,qr,_.variantStyle,_.collectionOptions);E("plans-v2",Z,jr,Z.variantStyle,Z.collectionOptions);E("product",Ce,Wr,Ce.variantStyle);E("segment",Ae,Yr,Ae.variantStyle);E("media",Te,Xr,Te.variantStyle);E("headless",_e,ia,_e.variantStyle);E("special-offers",Le,Jr,Le.variantStyle);E("simplified-pricing-express",ze,Bt,ze.variantStyle);E("full-pricing-express",Pe,qt,Pe.variantStyle);E("mini",Me,oa,Me.variantStyle);E("image",oe,_r,oe.variantStyle);E("fries",Re,Ut,Re.variantStyle);var Li=(a,t,e)=>{try{let r=la.get(a.variant);if(r||(r=new CSSStyleSheet,r.replaceSync(t.cssText),la.set(a.variant,r)),e?.styleSheet&&e.styleSheet!==r){let i=a.shadowRoot.adoptedStyleSheets.indexOf(e.styleSheet);i!==-1&&a.shadowRoot.adoptedStyleSheets.splice(i,1)}return a.shadowRoot.adoptedStyleSheets.includes(r)||a.shadowRoot.adoptedStyleSheets.push(r),{styleSheet:r}}catch{let i=document.createElement("style");i.textContent=t.cssText,i.setAttribute("data-variant-style",a.variant);let n=e?.styleElement||a.shadowRoot.querySelector("[data-variant-style]");return n&&n.remove(),a.shadowRoot.appendChild(i),{styleElement:i}}},Gt=a=>{let t=wt.get(a.variant);if(!t)return;let{class:e,style:r}=t,i=sa.get(a);if(i?.appliedVariant===a.variant)return new e(a);let n=r?Li(a,r,i):{};return sa.set(a,{appliedVariant:a.variant,...n}),new e(a)};function ut(a){return wt.get(a)?.fragmentMapping}function da(a){return wt.get(a)?.collectionOptions}var ha=document.createElement("style");ha.innerHTML=`
:root {
