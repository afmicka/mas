...
`,dc=()=>[v`
        ...
        `];M();function Uh(){return customElements.get("sp-tooltip")!==void 0||document.querySelector("sp-theme")!==null}var Bt=class extends U{constructor(){super(),this.size="m",this.alt="",this.loading="lazy"}connectedCallback(){super.connectedCallback(),setTimeout(()=>this.handleTooltips(),0)}handleTooltips(){if(Uh())return;this.querySelectorAll("sp-tooltip, overlay-trigger").forEach(r=>{let i="",a="top";if(r.tagName==="SP-TOOLTIP")i=r.textContent,a=r.getAttribute("placement")||"top";else if(r.tagName==="OVERLAY-TRIGGER"){let n=r.querySelector("sp-tooltip");n&&(i=n.textContent,a=n.getAttribute("placement")||r.getAttribute("placement")||"top")}if(i){let n=document.createElement("mas-mnemonic");n.setAttribute("content",i),n.setAttribute("placement",a);let o=this.querySelector("img"),s=this.querySelector("a");s&&s.contains(o)?n.appendChild(s):o&&n.appendChild(o),this.innerHTML="",this.appendChild(n),Promise.resolve().then(()=>Fi())}r.remove()})}render(){let{href:t}=this;return t?u`<a href="${t}">
                  ...
                  alt="${this.alt}"
                  loading="${this.loading}"
              />`}};m(Bt,"properties",{size:{type:String,attribute:!0},src:{type:String,attribute:!0},alt:{type:String,attribute:!0},href:{type:String,attribute:!0},loading:{type:String,attribute:!0}}),m(Bt,"styles",v`
        :host {
            --img-width: 32px;
            --img-height: 32px;
            display: block;
...
`;document.head.appendChild(Bc);var Fc="fragment",Uc="author",Gc="preview",qc="loading",Vc="timeout",Mn="aem-fragment",jc="eager",Wc="cache",Wh=[jc,Wc],Oe,Et,ke,Rn=class{constructor(){E(this,Oe,new Map);E(this,Et,new Map);E(this,ke,new Map)}clear(){p(this,Oe).clear(),p(this,Et).clear(),p(this,ke).clear()}add(t,r=!0){if(!this.has(t.id)&&!this.has(t.fields?.originalId)){if(p(this,Oe).set(t.id,t),t.fields?.originalId&&p(this,Oe).set(t.fields.originalId,t),p(this,ke).has(t.id)){let[,i]=p(this,ke).get(t.id);i()}if(p(this,ke).has(t.fields?.originalId)){let[,i]=p(this,ke).get(t.fields?.originalId);i()}if(!(!r||typeof t.references!="object"||Array.isArray(t.references)))for(let i in t.references){let{type:a,value:n}=t.references[i];a==="content-fragment"&&(n.settings={...t?.settings,...n.settings},n.placeholders={...t?.placeholders,...n.placeholders},n.dictionary={...t?.dictionary,...n.dictionary},n.priceLiterals={...t?.priceLiterals,...n.priceLiterals},this.add(n,t))}}}has(t){return p(this,Oe).has(t)}entries(){return p(this,Oe).entries()}get(t){return p(this,Oe).get(t)}getAsPromise(t){let[r]=p(this,ke).get(t)??[];if(r)return r;let i;return r=new Promise(a=>{i=a,this.has(t)&&a()}),p(this,ke).set(t,[r,i]),r}getFetchInfo(t){let r=p(this,Et).get(t);return r||(r={url:null,retryCount:0,stale:!1,measure:null,status:null},p(this,Et).set(t,r)),r}remove(t){p(this,Oe).delete(t),p(this,Et).delete(t),p(this,ke).delete(t)}};Oe=new WeakMap,Et=new WeakMap,ke=new WeakMap;var Qe=new Rn,er,_e,Ue,Ee,fe,J,Wr,Yr,Pe,Xr,Kr,tr,Le,Yc,Xc,On,Kc,Wi=class extends HTMLElement{constructor(){super(...arguments);E(this,Le);m(this,"cache",Qe);E(this,er);E(this,_e,null);E(this,Ue,null);E(this,Ee,null);E(this,fe);E(this,J);E(this,Wr,jc);E(this,Yr,5e3);E(this,Pe);E(this,Xr,!1);E(this,Kr,0);E(this,tr)}static get observedAttributes(){return[Fc,qc,Vc,Uc,Gc]}attributeChangedCallback(r,i,a){r===Fc&&(y(this,fe,a),y(this,J,Qe.getFetchInfo(a))),r===qc&&Wh.includes(a)&&y(this,Wr,a),r===Vc&&y(this,Yr,parseInt(a,10)),r===Uc&&y(this,Xr,["","true"].includes(a)),r===Gc&&y(this,tr,a)}connectedCallback(){if(!p(this,Pe)){if(p(this,Ee)??y(this,Ee,mt(this)),y(this,tr,p(this,Ee).settings?.preview),p(this,er)??y(this,er,p(this,Ee).log.module(`${Mn}[${p(this,fe)}]`)),!p(this,fe)||p(this,fe)==="#"){p(this,J)??y(this,J,Qe.getFetchInfo("missing-fragment-id")),Z(this,Le,On).call(this,"Missing fragment id");return}this.refresh(!1)}}get fetchInfo(){return Object.fromEntries(Object.entries(p(this,J)).filter(([r,i])=>i!=null).map(([r,i])=>[`aem-fragment:${r}`,i]))}async refresh(r=!0){if(p(this,Pe)&&!await Promise.race([p(this,Pe),Promise.resolve(!1)]))return;r&&Qe.remove(p(this,fe)),p(this,Wr)===Wc&&await Promise.race([Qe.getAsPromise(p(this,fe)),new Promise(s=>setTimeout(s,p(this,Yr)))]);try{y(this,Pe,Z(this,Le,Kc).call(this)),await p(this,Pe)}catch(s){return Z(this,Le,On).call(this,s.message),!1}let{references:i,referencesTree:a,placeholders:n,wcs:o}=p(this,_e)||{};return o&&!F("mas.disableWcsCache")&&p(this,Ee).prefillWcsCache(o),this.dispatchEvent(new CustomEvent(at,{detail:{...this.data,references:i,referencesTree:a,placeholders:n,...p(this,J)},bubbles:!0,composed:!0})),p(this,Pe)}get updateComplete(){return p(this,Pe)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return p(this,Ue)?p(this,Ue):(p(this,Xr)?this.transformAuthorData():this.transformPublishData(),p(this,Ue))}get rawData(){return p(this,_e)}transformAuthorData(){let{fields:r,id:i,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:c={}}=p(this,_e);y(this,Ue,r.reduce((l,{name:d,multiple:h,values:g})=>(l.fields[d]=h?g:g[0],l),{fields:{},id:i,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:c}))}transformPublishData(){let{fields:r,id:i,tags:a,settings:n={},priceLiterals:o={},dictionary:s={},placeholders:c={}}=p(this,_e);y(this,Ue,Object.entries(r).reduce((l,[d,h])=>(l.fields[d]=h?.mimeType?h.value:h??"",l),{fields:{},id:i,tags:a,settings:n,priceLiterals:o,dictionary:s,placeholders:c}))}getFragmentClientUrl(){let i=new URLSearchParams(window.location.search).get("maslibs");if(!i||i.trim()==="")return"https://mas.adobe.com/studio/libs/fragment-client.js";let a=i.trim().toLowerCase();if(a==="local")return"http://localhost:3000/studio/libs/fragment-client.js";let{hostname:n}=window.location,o=n.endsWith(".page")?"page":"live";return a.includes("--")?`https://${a}.aem.${o}/studio/libs/fragment-client.js`:`https://${a}--mas--adobecom.aem.${o}/studio/libs/fragment-client.js`}async generatePreview(){let r=this.getFragmentClientUrl(),{previewFragment:i}=await import(r);return await i(p(this,fe),{locale:p(this,Ee).settings.locale,apiKey:p(this,Ee).settings.wcsApiKey})}};er=new WeakMap,_e=new WeakMap,Ue=new WeakMap,Ee=new WeakMap,fe=new WeakMap,J=new WeakMap,Wr=new WeakMap,Yr=new WeakMap,Pe=new WeakMap,Xr=new WeakMap,Kr=new WeakMap,tr=new WeakMap,Le=new WeakSet,Yc=async function(r){Zn(this,Kr)._++;let i=`${Mn}:${p(this,fe)}:${p(this,Kr)}`,a=`${i}${st}`,n=`${i}${ct}`;if(p(this,tr))return await this.generatePreview();performance.mark(a);let o;try{if(p(this,J).stale=!1,p(this,J).url=r,o=await Oi(r,{cache:"default",credentials:"omit"}),Z(this,Le,Xc).call(this,o),p(this,J).status=o?.status,p(this,J).measure=Re(performance.measure(n,a)),p(this,J).retryCount=o.retryCount,!o?.ok)throw new ze("Unexpected fragment response",{response:o,...p(this,Ee).duration});return await o.json()}catch(s){if(p(this,J).measure=Re(performance.measure(n,a)),p(this,J).retryCount=s.retryCount,p(this,_e))return p(this,J).stale=!0,p(this,er).error("Serving stale data",p(this,J)),p(this,_e);let c=s.message??"unknown";throw new ze(`Failed to fetch fragment: ${c}`,{})}},Xc=function(r){Object.assign(p(this,J),xi(r))},On=function(r){y(this,Pe,null),p(this,J).message=r,this.classList.add("error");let i={...p(this,J),...p(this,Ee).duration};p(this,er).error(r,i),this.dispatchEvent(new CustomEvent(nt,{detail:i,bubbles:!0,composed:!0}))},Kc=async function(){var c;this.classList.remove("error"),y(this,Ue,null);let r=Qe.get(p(this,fe));if(r)return y(this,_e,r),!0;let{masIOUrl:i,wcsApiKey:a,country:n,locale:o}=p(this,Ee).settings,s=`${i}/fragment?id=${p(this,fe)}&api_key=${a}&locale=${o}`;return n&&!o.endsWith(`_${n}`)&&(s+=`&country=${n}`),r=await Z(this,Le,Yc).call(this,s),(c=r.fields).originalId??(c.originalId=p(this,fe)),Qe.add(r),y(this,_e,r),!0},m(Wi,"cache",Qe);customElements.define(Mn,Wi);M();Fr();var Qc={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Zc=e=>(...t)=>({_$litDirective$:e,values:t}),Yi=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,r,i){this._$Ct=t,this._$AM=r,this._$Ci=i}_$AS(t,r){return this.update(t,r)}update(t,r){return this.render(...r)}};var Qr=class extends Yi{constructor(t){if(super(t),this.et=w,t.type!==Qc.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===w||t==null)return this.ft=void 0,this.et=t;if(t===Fe)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.et)return this.ft;this.et=t;let r=[t];return r.raw=r,this.ft={_$litType$:this.constructor.resultType,strings:r,values:[]}}};Qr.directiveName="unsafeHTML",Qr.resultType=1;var Jc=Zc(Qr);var Yh=e=>e?e.startsWith("sp-icon-")?u`${Jc(`<${e} class="badge-icon"></${e}>`)}`:u`<img src="${e}" class="badge-icon" />`:w,rr=class extends U{constructor(){super(),this.color="",this.variant="",this.backgroundColor="",this.borderColor="",this.text=this.textContent,this.icon=""}connectedCallback(){this.borderColor&&this.borderColor!=="transparent"?this.style.setProperty("--merch-badge-border",`1px solid var(--${this.borderColor})`):this.backgroundColor.startsWith("gradient-")||this.style.setProperty("--merch-badge-border",`1px solid var(--${this.backgroundColor})`),this.style.setProperty("--merch-badge-background-color",`var(--${this.backgroundColor})`),(!this.borderColor||this.borderColor==="transparent")&&this.backgroundColor.startsWith("gradient-")?this.style.setProperty("--merch-badge-padding","3px 11px 4px 11px"):this.style.setProperty("--merch-badge-padding","2px 10px 3px 10px"),this.style.setProperty("--merch-badge-color",this.color),this.style.setProperty("--merch-badge-font-size","var(--consonant-merch-card-body-xs-font-size)"),this.textContent="";let t=this.closest("merch-card"),r=t?.getAttribute("size"),i=t?.querySelectorAll(":scope > merch-icon").length||0;this.style.setProperty("--merch-badge-offset",i),this.style.setProperty("--merch-badge-with-offset",i?1:0),this.style.setProperty("--merch-badge-card-size",r?2:1),super.connectedCallback()}render(){return u`<div class="badge">
        ...
        </div>`}};m(rr,"properties",{color:{type:String},variant:{type:String},backgroundColor:{type:String,attribute:"background-color"},borderColor:{type:String,attribute:"border-color"},icon:{type:String}}),m(rr,"styles",v`
        :host {
            display: block;
    ...
    `),m(Zr,"properties",{description:{type:String,attribute:!0}});customElements.define("merch-mnemonic-list",Zr);M();var Jr=class extends U{updated(){this.hideSeeMoreEls()}hideSeeMoreEls(){this.isMobile&&this.rows.forEach((t,r)=>{r>=5&&(t.style.display=this.showAll?"flex":"none")})}constructor(){super(),this.showAll=!1,this.mobileRows=this.mobileRows===void 0?5:this.mobileRows}toggle(){this.showAll=!this.showAll,this.dispatchEvent(new CustomEvent("hide-see-more-elements",{bubbles:!0,composed:!0})),this.requestUpdate()}render(){return u`<slot name="heading"></slot>
            ...
            ${this.isMobile&&this.rows.length>this.mobileRows&&!this.bulletsAdded?u`<div @click=${this.toggle} class="see-more">
                  ...
                  </div>`:w}`}get isMobile(){return window.matchMedia("(max-width: 767px)").matches}get rows(){return this.querySelectorAll('[slot="content"] merch-mnemonic-list')}get bulletsAdded(){return!!this.querySelector('[slot="contentBullets"] merch-mnemonic-list')}};m(Jr,"styles",v`
        :host {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
    ...
    `),m(ri,"properties",{offers:{type:Array},selectedOffer:{type:Object},defaults:{type:Object},variant:{type:String,attribute:"variant",reflect:!0},planType:{type:String,attribute:"plan-type",reflect:!0},stock:{type:Boolean,reflect:!0}});customElements.define("merch-offer-select",ri);M();M();var sl=v`
    :host {
...
`;var pl={backgroundImage:{attribute:"background-image"},badge:!0,ctas:{slot:"cta",size:"M"},description:{tag:"div",slot:"body-xs"},mnemonics:{size:"l"},prices:{tag:"p",slot:"price"},size:[],subtitle:{tag:"h4",slot:"detail-s"},title:{tag:"h3",slot:"heading-xs"}},cr=class extends C{getGlobalCSS(){return hl}get stripStyle(){return this.card.backgroundImage?`
        ...
        `:""}renderLayout(){return u` <div style="${this.stripStyle}" class="body">
            ...
            <slot></slot>`}postCardUpdateHook(t){t.has("backgroundImage")&&this.styleBackgroundImage()}styleBackgroundImage(){if(this.card.classList.remove("thin-strip"),this.card.classList.remove("wide-strip"),!this.card.backgroundImage)return;let t=new Image;t.src=this.card.backgroundImage,t.onload=()=>{t.width>8?this.card.classList.add("wide-strip"):t.width===8&&this.card.classList.add("thin-strip")}}};m(cr,"variantStyle",v`
