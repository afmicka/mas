...
import { createWorkerPageSetup, addUrlQueryParams, validateCommerceUrl, DOCS_GALLERY_PATH } from '../../utils/commerce.js';
...
test.describe('CCD Merchcard feature test suite', () => {
    ...
    test(`${features[0].name},${features[0].tags}`, async () => {
        ...
        await test.step('step-3: Verify CCD Merch Card spec', async () => {
            ...
            expect(
                await webUtil.verifyCSS(await CCD.getCardIcon(data.id, 'suggested'), CCD.suggestedCssProp.icon),
            ).toBeTruthy();
            expect(
                await webUtil.verifyCSS(await CCD.getCardEyebrow(data.id, 'suggested'), CCD.suggestedCssProp.eyebrow.light),
            ).toBeTruthy();
            expect(
                await webUtil.verifyCSS(await CCD.getCardTitle(data.id, 'suggested'), CCD.suggestedCssProp.title.light),
            ).toBeTruthy();
            expect(
                await webUtil.verifyCSS(
                    await CCD.getCardDescription(data.id, 'suggested'),
                    CCD.suggestedCssProp.description.light,
                ),
            ).toBeTruthy();
            expect(
                await webUtil.verifyCSS(await CCD.getCardPrice(data.id, 'suggested'), CCD.suggestedCssProp.price.light),
            ).toBeTruthy();
            expect(
                await webUtil.verifyCSS(await CCD.getCardCTA(data.id, 'suggested'), CCD.suggestedCssProp.cta.light),
            ).toBeTruthy();
        });
        ...
        await test.step('step-5: Verify CCD Merch Card spec in dark mode', async () => {
            ...
            expect(
                await webUtil.verifyCSS(await CCD.getCardEyebrow(data.id, 'suggested'), CCD.suggestedCssProp.eyebrow.dark),
            ).toBeTruthy();
            expect(
                await webUtil.verifyCSS(await CCD.getCardTitle(data.id, 'suggested'), CCD.suggestedCssProp.title.dark),
            ).toBeTruthy();
            expect(
                await webUtil.verifyCSS(
                    await CCD.getCardDescription(data.id, 'suggested'),
                    CCD.suggestedCssProp.description.dark,
                ),
            ).toBeTruthy();
            expect(
                await webUtil.verifyCSS(await CCD.getCardPrice(data.id, 'suggested'), CCD.suggestedCssProp.price.dark),
            ).toBeTruthy();
            expect(
                await webUtil.verifyCSS(await CCD.getCardCTA(data.id, 'suggested'), CCD.suggestedCssProp.cta.dark),
            ).toBeTruthy();
        });
    });
    ...
    test(`${features[1].name},${features[1].tags}`, async () => {
        ...
        await test.step('step-2: Verify CCD Merch Card content', async () => {
            ...
            await expect(await CCD.getCardLegalLink(data.id, 'suggested')).toHaveAttribute(
                'data-analytics-id',
                data.linkAnalyticsId,
            );
            await expect(await CCD.getCardLegalLink(data.id, 'suggested')).toHaveAttribute('daa-ll', data.linkDaaLL);
            await expect(await CCD.getCardPrice(data.id, 'suggested')).toBeVisible();
            await expect(await CCD.getCardPrice(data.id, 'suggested')).toContainText(new RegExp(data.price));
            await expect(await (await CCD.getCardPrice(data.id, 'suggested')).locator(CCD.priceStrikethrough)).toContainText(
                new RegExp(data.strikethroughPrice),
            );
            ...
            const ctaHref = await (await CCD.getCardCTALink(data.id, 'suggested')).evaluate((el) => el.href);
            expect(validateCommerceUrl(ctaHref)).toBe(true);
            await expect(await CCD.getCardCTALink(data.id, 'suggested')).toHaveAttribute(
                'data-analytics-id',
                data.ctaAnalyticsId,
            );
        ...
        await test.step('step-3: Verify CCD Merch Card spec', async () => {
            ...
            expect(
                await webUtil.verifyCSS(await CCD.getCardLegalLink(data.id, 'suggested'), CCD.suggestedCssProp.legalLink.light),
            ).toBeTruthy();
            expect(
                await webUtil.verifyCSS(await CCD.getCardPrice(data.id, 'suggested'), CCD.suggestedCssProp.price.light),
            ).toBeTruthy();
            expect(
                await webUtil.verifyCSS(
                    await CCD.getCardPriceStrikethrough(data.id, 'suggested'),
                    CCD.suggestedCssProp.strikethroughPrice.light,
                ),
            ).toBeTruthy();
            expect(
                await webUtil.verifyCSS(await CCD.getCardCTA(data.id, 'suggested'), CCD.suggestedCssProp.cta.light),
        ...
        await test.step('step-5: Verify CCD Merch Card spec', async () => {
            ...
            expect(
                await webUtil.verifyCSS(await CCD.getCardLegalLink(data.id, 'suggested'), CCD.suggestedCssProp.legalLink.dark),
            ).toBeTruthy();
            expect(
                await webUtil.verifyCSS(
                    await CCD.getCardDescription(data.id, 'suggested'),
            ...
            expect(
                await webUtil.verifyCSS(
                    await CCD.getCardPriceStrikethrough(data.id, 'suggested'),
                    CCD.suggestedCssProp.strikethroughPrice.dark,
                ),
            ).toBeTruthy();
            expect(
                await webUtil.verifyCSS(await CCD.getCardCTA(data.id, 'suggested'), CCD.suggestedCssProp.cta.dark),
    ...
    test(`${features[3].name},${features[3].tags}`, async () => {
        ...
        await test.step('step-2: Verify CCD Merch Card content/specs', async () => {
            ...
            expect(validateCommerceUrl(ctaHref)).toBe(true);
            await expect(await CCD.getCardCTALink(data.id, 'suggested')).toHaveAttribute('data-analytics-id', /.*/);
            await expect(await CCD.getCard(data.id, 'suggested')).toHaveAttribute(
                'background-image',
                new RegExp(data.background),
            );
        });
    ...
    test(`${features[8].name},${features[8].tags}`, async () => {
        ...
        await test.step('step-3: Verify CCD Merch Card spec', async () => {
            ...
            expect(
                await webUtil.verifyCSS(await CCD.getCardDescription(data.id, 'slice'), CCD.sliceCssProp.description.light),
            ).toBeTruthy();
        ...
        await test.step('step-5: Verify CCD Merch Card spec', async () => {
            ...
            expect(await webUtil.verifyCSS(await CCD.getCardIcon(data.id, 'slice'), CCD.sliceCssProp.icon)).toBeTruthy();
            expect(
                await webUtil.verifyCSS(await CCD.getCardDescription(data.id, 'slice'), CCD.sliceCssProp.description.dark),
            ).toBeTruthy();
    ...
    test(`${features[9].name},${features[9].tags}`, async () => {
        ...
        await test.step('step-3: Verify CCD Merch Card spec', async () => {
            ...
            expect(
                await webUtil.verifyCSS(await CCD.getCardPrice(data.id, 'slice'), CCD.sliceCssProp.price.light),
            ).toBeTruthy();
            expect(await webUtil.verifyCSS(await CCD.getCardCTA(data.id, 'slice'), CCD.sliceCssProp.cta.light)).toBeTruthy();
        });
    ...
    test(`${features[10].name},${features[10].tags}`, async () => {
        ...
        await test.step('step-3: Verify CCD Merch Card spec', async () => {
            ...
            expect(
                await webUtil.verifyCSS(await CCD.getCardLegalLink(data.id, 'slice'), CCD.sliceCssProp.legalLink.light),
            ).toBeTruthy();
            expect(
                await webUtil.verifyCSS(await CCD.getCardPrice(data.id, 'slice'), CCD.sliceCssProp.price.light),
            ).toBeTruthy();
        ...
        await test.step('step-5: Verify CCD Merch Card spec', async () => {
            ...
            expect(await webUtil.verifyCSS(await CCD.getCardIcon(data.id, 'slice'), CCD.sliceCssProp.icon)).toBeTruthy();
            expect(
                await webUtil.verifyCSS(await CCD.getCardLegalLink(data.id, 'slice'), CCD.sliceCssProp.legalLink.dark),
            ).toBeTruthy();
            expect(
                await webUtil.verifyCSS(await CCD.getCardDescription(data.id, 'slice'), CCD.sliceCssProp.description.dark),
            ).toBeTruthy();
    ...
    test(`${features[14].name},${features[14].tags}`, async () => {
        ...
        await test.step('step-2: Verify CCD Merch Card content', async () => {
            ...
            await expect(await CCD.getCardLegalLink(data.id, 'slice-wide')).toHaveAttribute(
                'data-analytics-id',
                data.linkAnalyticsId,
            );
        ...
        await test.step('step-3: Verify CCD Merch Card spec', async () => {
            ...
            expect(
                await webUtil.verifyCSS(
                    await CCD.getCardDescription(data.id, 'slice-wide'),
                    CCD.sliceCssProp.description.light,
                ),
            ).toBeTruthy();
            expect(
                await webUtil.verifyCSS(await CCD.getCardLegalLink(data.id, 'slice-wide'), CCD.sliceCssProp.legalLink.light),
            ).toBeTruthy();
            expect(
                await webUtil.verifyCSS(await CCD.getCardFooterLink(data.id, 'slice-wide'), CCD.sliceCssProp.cta.light),
            ).toBeTruthy();
        });
        ...
        await test.step('step-5: Verify CCD Merch Card spec', async () => {
            ...
            expect(await webUtil.verifyCSS(await CCD.getCardIcon(data.id, 'slice-wide'), CCD.sliceCssProp.icon)).toBeTruthy();
            expect(
                await webUtil.verifyCSS(await CCD.getCardLegalLink(data.id, 'slice-wide'), CCD.sliceCssProp.legalLink.dark),
            ).toBeTruthy();
            expect(
                await webUtil.verifyCSS(await CCD.getCardDescription(data.id, 'slice-wide'), CCD.sliceCssProp.description.dark),
            ).toBeTruthy();
            expect(
                await webUtil.verifyCSS(await CCD.getCardFooterLink(data.id, 'slice-wide'), CCD.sliceCssProp.cta.dark),
            ).toBeTruthy();
        });
    });
    ...
    test(`${features[15].name},${features[15].tags}`, async () => {
        ...
        await test.step('step-3: Verify CCD Merch Card spec', async () => {
            ...
            expect(
                await webUtil.verifyCSS(await CCD.getCardCTA(data.id, 'slice-wide'), CCD.sliceCssProp.cta.light),
            ).toBeTruthy();
        });
        ...
        await test.step('step-5: Verify CCD Merch Card spec', async () => {
            ...
            expect(
                await webUtil.verifyCSS(await CCD.getCardCTA(data.id, 'slice-wide'), CCD.sliceCssProp.cta.dark),
            ).toBeTruthy();
        });
    });
    ...
    test(`${features[16].name},${features[16].tags}`, async () => {
        ...
        await test.step('step-3: Verify CCD Merch Card spec', async () => {
            ...
            expect(
                await webUtil.verifyCSS(await CCD.getCardPrice(data.id, 'slice-wide'), CCD.sliceCssProp.price.light),
            ).toBeTruthy();
            expect(
                await webUtil.verifyCSS(await CCD.getCardCTA(data.id, 'slice-wide'), CCD.sliceCssProp.cta.light),
            ).toBeTruthy();
        ...
        await test.step('step-5: Verify CCD Merch Card spec', async () => {
            ...
            expect(
                await webUtil.verifyCSS(await CCD.getCardPrice(data.id, 'slice-wide'), CCD.sliceCssProp.price.dark),
            ).toBeTruthy();
            expect(
                await webUtil.verifyCSS(await CCD.getCardCTA(data.id, 'slice-wide'), CCD.sliceCssProp.cta.dark),
            ).toBeTruthy();
    ...
    test(`${features[17].name},${features[17].tags}`, async () => {
        ...
        await test.step('step-2: Verify CCD Merch Card content', async () => {
            ...
            await expect(await CCD.getCardPriceStrikethrough(data.id, 'slice-wide')).toContainText(
                new RegExp(data.strikethroughPrice),
            );
            await expect(await CCD.getCardCTA(data.id, 'slice-wide')).toBeVisible();
            await expect(await CCD.getCardCTA(data.id, 'slice-wide')).toHaveAttribute('class', /accent/);
        ...
        await test.step('step-3: Verify CCD Merch Card spec', async () => {
            ...
            expect(
                await webUtil.verifyCSS(
                    await CCD.getCardPriceStrikethrough(data.id, 'slice-wide'),
                    CCD.sliceCssProp.strikethroughPrice.light,
                ),
            ).toBeTruthy();
            expect(
                await webUtil.verifyCSS(await CCD.getCardCTA(data.id, 'slice-wide'), CCD.sliceCssProp.cta.light),
        ...
        await test.step('step-5: Verify CCD Merch Card spec', async () => {
            ...
            expect(
                await webUtil.verifyCSS(
                    await CCD.getCardPriceStrikethrough(data.id, 'slice-wide'),
                    CCD.sliceCssProp.strikethroughPrice.dark,
                ),
            ).toBeTruthy();
            expect(
                await webUtil.verifyCSS(await CCD.getCardCTA(data.id, 'slice-wide'), CCD.sliceCssProp.cta.dark),
    ...
    test(`${features[24].name},${features[24].tags}`, async () => {
        ...
        await test.step('step-2: Verify CCD Merch Card content/specs', async () => {
            ...
            await expect(await CCD.getCardPrice(data.id, 'suggested')).toBeVisible();
            await expect(await CCD.getCardPrice(data.id, 'suggested')).toContainText(new RegExp(data.price));
            expect(await (await CCD.getCardPrice(data.id, 'suggested')).locator('.price-unit-type').innerText()).toContain(
                data.priceUnit,
            );
            await expect(await CCD.getCardCTA(data.id, 'suggested')).toBeVisible();
            await expect(await CCD.getCardCTA(data.id, 'suggested')).toHaveAttribute('class', /primary/);
